...
use app\models\Claimpalliative;

/**
 * ClaimpalliativeSearch represents the model behind the search form of `app\models\Claimpalliative`.
 */
class ClaimpalliativeSearch extends Claimpalliative
{
    /**
     * {@inheritdoc}
     */
