 ...
 * @property string|null $dxop2 เกณฑ์ข้อ2
 * @property string|null $dxop3 เกณฑ์ข้อ3
 * @property string|null $dxop4 เกณฑ์ข้อ4
 * @property int|null $dxop5 เกณฑ์ข้อ5
 * @property int|null $dxop6 เกณฑ์ข้อ6
 * @property string|null $dxop7 เกณฑ์ข้อ7
 ...
 * @property string|null $other8 เกณฑ์ข้อ8
 * @property string|null $other9 เกณฑ์ข้อ9
 ...
 * @property string|null $pe4 ข้อ4
 * @property int|null $pe5 ข้อ5
 * @property int|null $pe6 เกณฑ์ข้อ6
 * @property string|null $pe7 เกณฑ์ข้อ7
 ...
 * @property string|null $cr1 ข้อ1
 * @property string|null $cr2 ข้อ2
 * @property string|null $cr3 ข้อ3
 * @property string|null $cr4 ข้อ4
 * @property string|null $cr5 ข้อ5
 * @property string|null $cr6 เกณฑ์ข้อ6
 * @property string|null $cr7 เกณฑ์ข้อ7
 * @property string|null $cr8 เกณฑ์ข้อ8
 * @property string|null $cr9 เกณฑ์ข้อ9
 * @property string|null $cr_huk หักคะแนน
 * @property string|null $NA8
 * @property string|null $Missing8
 * @property string|null $No8
 * @property string|null $ar1 ข้อ1
 * @property string|null $ar2 ข้อ2
 * @property string|null $ar3 ข้อ3
 * @property string|null $ar4 ข้อ4
 * @property string|null $ar5 ข้อ5
 * @property string|null $ar6 เกณฑ์ข้อ6
 * @property string|null $ar7 เกณฑ์ข้อ7
 * @property string|null $ar8 เกณฑ์ข้อ8
 * @property string|null $ar9 เกณฑ์ข้อ9
 * @property int|null $ar_huk หักคะแนน
 * @property string|null $NA9
 * @property string|null $Missing9
 * @property string|null $No9
 * @property string|null $on1 ข้อ1
 * @property string|null $on2 ข้อ2
 * @property string|null $on3 ข้อ3
 * @property string|null $on4 ข้อ4
 * @property string|null $on5 ข้อ5
 * @property string|null $on6 เกณฑ์ข้อ6
 * @property string|null $on7 เกณฑ์ข้อ7
 * @property string|null $on8 เกณฑ์ข้อ8
 * @property string|null $on9 เกณฑ์ข้อ9
 * @property int|null $on_huk หักคะแนน
 * @property string|null $NA10
 * @property string|null $Missing10
 * @property string|null $No10
 * @property string|null $lr1 ข้อ1
 * @property string|null $lr2 ข้อ2
 * @property string|null $lr3 ข้อ3
 * @property string|null $lr4 ข้อ4
 * @property string|null $lr5 ข้อ5
 * @property string|null $lr6 เกณฑ์ข้อ6
 * @property string|null $lr7 เกณฑ์ข้อ7
 * @property string|null $lr8 เกณฑ์ข้อ8
 * @property string|null $lr9 เกณฑ์ข้อ9
 ...
 * @property string|null $nn2 ข้อ2
 * @property string|null $nn3 ข้อ3
 * @property string|null $nn4 ข้อ4
 * @property int|null $nn5 ข้อ5
 * @property int|null $nn6 เกณฑ์ข้อ6
 * @property string|null $nn7 เกณฑ์ข้อ7
...
class Mraipd extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(Departmetnsipd::className(), ['unit_id' => 'unit_id']);
    }
}
