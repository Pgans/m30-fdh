...
LEFT JOIN cost_visits cos ON cos.visit_id = o.visit_id 
          WHERE o.IS_CANCEL = 0
		  AND o.REG_DATETIME BETWEEN '2024-04-26 00:01' AND '2024-04-30 23:59'
           # AND o.REG_DATETIME BETWEEN DATE_SUB(NOW(), INTERVAL 6 DAY) AND NOW()
