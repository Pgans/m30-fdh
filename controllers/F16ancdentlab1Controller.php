...
class F16ancdentlab1Controller extends \yii\web\Controller
{
...
foreach ($vn as $r) {
    ...
    if ($table === 'pat') {
        ...
        // ถ้าไม่มีข้อมูลใน fdh_ins ให้ใช้จาก fdh_ancdent_lab1
        if (empty($results)) {
            $queryHerb = "SELECT main_query FROM fdh_ancdent_lab1 WHERE main_table = :table";
