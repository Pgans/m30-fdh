...
(SELECT DATE_FORMAT(o.reg_datetime, '%Y-%m-%d %H:%i') as 'regdate'
   ...
   , CONCAT(
	 ...
	 #LEFT JOIN authen_kiosk ak ON p.CID = ak.cid  AND date(o.REG_DATETIME)=date(ak.d_update)
	  ...
	  #AND i9.code in ('2387010','2330011')  
	  #AND o.visit_id in ('0003093407','0003095805','0003082983','0003095794')
	...
	WHERE  v.users = 'ancdent' AND v.messagecode <> ''
	...
	AND l.messagecode <> '' AND l.users = 'ancdent'
	...
	AND l.messagecode <> 'success' AND l.users = 'ancdent'
	ORDER BY l.d_update DESC
