...
(SELECT 
    ...
    CASE
        ...
        ELSE 'N'
    END as uuid,
    COALESCE((cg01 + cg02 + cg03 + cg04 + cg05 + cg06 + cg07 + cg08 + cg09 + cg10 + cg11 + cg12 + cg13 + cg14 + cg15 + cg16 + cg17 + cg18 + cg19), 50) AS amount,
    o.inscl,
...
ORDER BY No DESC, amount DESC;
 ...
 ";
    ...
    $visitProvider = new \yii\data\ArrayDataProvider([
        ...
        $data = \yii::$app->db14->createCommand($today_ipd)->queryOne();
