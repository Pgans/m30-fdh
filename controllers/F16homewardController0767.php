...
class F16homewardController extends \yii\web\Controller
{
    public function actionIndex()
    {
        ...
        LEFT JOIN log_all.log_fdh_ipd_ck   as log ON log.visit_id = o.visit_id
        WHERE o.IS_CANCEL = 0
        ...
        AND l.messagecode = 'success' AND l.users = 'homeword'
  ...
  private function sendDataToAPI($visit, $an)
{
    ...
    if ($data && isset($data['token30'])) {
		...
		## https://fdh.moph.go.th/api/v2/data_hub/16_files/  ***  https://uat-fdh.inet.co.th/api/v2/data_hub/16_files/
        $client = new Client();
