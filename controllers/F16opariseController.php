...
class F16opariseController extends \yii\web\Controller
{
    public function actionIndex()
    {
       ...
       , CONCAT(
          ...
          WHERE o.IS_CANCEL = 0
            ...
            AND date(o.reg_datetime)=g.uc_register
        ...
        WHERE  v.users = 'oparise' AND v.messagecode <> ''
		#AND v.messages <> ''
        ...
        AND l.messagecode <> '' AND l.users = 'oparise'
        ...
        AND l.messagecode <> 'success' AND l.users = 'oparise'
        ORDER BY l.d_update DESC
 ...
 public function actionData()
{
    ...
    foreach ($vn as $r) {
        ...
        foreach ($tables as $table) {
            $query = "SELECT main_query FROM fdh_oparise WHERE main_table = '$table'";
                ...
                while ($row = fgetcsv($file, 0, "|")) {
                    ...
                    if ($visitCount > 0) {
                            ...
                            $logSQLUpdate = "UPDATE log_fdh_opd_ck SET pid = :pid, messages = :messages, messagecode = :messagecode, response = :response,
                             users = 'oparise', datereg = :datereg, d_update = NOW() WHERE visit_id = :visit_id";
                            ...
                            VALUES (:visit_id, :pid, :messages, :messagecode, :response, 'oparise',:datereg ,NOW())";
    ...
    public function actionExports()
        {
            ...
            $zipFilename = $baseDirectory . 'F16_10953_oparise_' . $currentDateTime . '.zip';
