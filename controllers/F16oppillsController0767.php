...
class F16oppillsController extends \yii\web\Controller
{
...
FROM (
    ...
    GROUP BY o.VISIT_ID
    ORDER BY o.visit_id , e.unit_id 
) AS data,
(SELECT @n := 0) AS n ORDER BY No DESC ;
        ...
        FROM log_fdh_opd v 
        WHERE v.messagecode = 'success' AND v.users = 'oppills'
        ...
        AND l.messagecode = 'success' AND l.users = 'oppills'
    ...
    public function actionData()
    {
        ...
        foreach ($vn as $r) {
            ...
            foreach ($tables as $table) {
                $query = "SELECT main_query FROM fdh_oppills WHERE main_table = '$table'";
    ...
    private function sendDataToAPI($visit, $hn)
    {
        ...
        if ($data && isset($data['token30'])) {
            ...
            VALUES ('$visit', '$hn', '$message', '$message_th', 'oppills', NOW())";
