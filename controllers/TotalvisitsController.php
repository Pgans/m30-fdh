...
class TotalvisitsController extends \yii\web\Controller
{
...
END as nhsocode,
   ...
   # LEFT JOIN icd10new icd1 ON icd1.icd10 = d1.icd10 
    ...
    WHERE o.REG_DATETIME BETWEEN '2025-04-01 00:01' AND '2025-04-10 23:59'
...
ORDER BY No DESC, charge_total DESC;
 ";
    ...
    $visitProvider = new \yii\data\ArrayDataProvider([
        ...
        AND l.messagecode = 'success' AND l.users = 'opd'
...
END AS amount
    ...
    $strSQL = "REPLACE INTO log_totalvisits (visit_id, pid, status, messagecode, message_th ,users, send_date, regdate) 
               VALUES ('$visit', '$hn', $status, '$message', '$message_th','opd', NOW(), '{$closeRow['regdatex']}')";
