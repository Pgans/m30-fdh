      ...
      (SELECT
       ...
       , CONCAT(
          ...
          LEFT(GROUP_CONCAT(DISTINCT TRIM(icd.ICD10_TM)), 30) AS Diag,
					...
					GROUP_CONCAT(DISTINCT l.lab_id) as labId,
        ...
        WHERE  v.users = 'ancdentuslab2' AND v.messagecode <> ''
        ...
        AND l.messagecode <> '' AND l.users = 'ancdentuslab2'
       ...
       AND l.messagecode <> 'success' AND l.users = 'ancdentuslab2'
       ORDER BY l.d_update DESC
