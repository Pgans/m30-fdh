...
(SELECT DATE_FORMAT(o.reg_datetime, '%Y-%m-%d %H:%i') as 'regdate'
       ...
       , CONCAT(
		 ...
		 LEFT JOIN icd9cm i9 ON i9.icd9 = op.icd9
		  ...
		  LEFT JOIN authen_kiosk ak ON p.CID = ak.cid  AND ak.d_update BETWEEN CONCAT(DATE(o.REG_DATETIME), ' 00:00:00') AND CONCAT(DATE(o.REG_DATETIME), ' 23:59:59')
        ...
        WHERE  v.users = 'ancuslab2' AND v.messagecode <> ''
		#AND v.messages <> ''
        ...
        AND l.messagecode <> '' AND l.users = 'ancuslab2'
        ...
        AND l.messagecode <> 'success' AND l.users = 'ancuslab2'
        ORDER BY l.d_update DESC
