    ...
    public function actionIndex()
    {
      ...
      (SELECT
       ...
       , CONCAT(
        ...
        WHERE  v.users = 'ancusupt' AND v.messagecode <> ''
        ...
        AND l.messagecode <> '' AND l.users = 'ancusupt'
       ...
       FROM log_fdh_opd_ck l 
       WHERE l.d_update BETWEEN CURDATE() AND NOW()
       AND l.messagecode <> '' AND l.users = 'ancuslab1upt'
       ORDER BY l.d_update DESC
       ...
       AND l.messagecode <> 'success' AND l.users = 'ancusupt'
       ORDER BY l.d_update DESC
