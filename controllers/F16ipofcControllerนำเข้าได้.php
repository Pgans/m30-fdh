...
class F16ipofcController extends \yii\web\Controller
{
    ...
    {
        $token = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI2MjEzMDMzMjQxNjIyIiwiZXhwIjoxNzQ5ODI3MTk3LCJpYXQiOjE3NDk4MTYzOTd9.VjnoBaCSDNcIEo8heTa8jN1QybW5K43FgyiVyikn4eewJzW0BxW4X8QsjQ7WiG0Tj0Kn2yu-me0UaeHJzybACg"; // ใส่ token จริงของคุณ
    ...
    {
        $fp = fopen(Yii::getAlias('@webroot/' . $filePath), 'w');
        foreach ($data as $row) {
            $line = [];
