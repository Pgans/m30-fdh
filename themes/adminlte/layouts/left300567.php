                ...
                'items' => [
                    ...
                    */
					[
                        ...
                        'items' => [
                            ['label' => 'Telemed', 'icon' => 'fa fa-check-square-o text-aqua', 'url' => ['/f16telemed/index']],
                            ['label' => 'Hurb สมุนไพรไทย', 'icon' => 'fa fa-check-square-o text-aqua', 'url' => ['/f16hurb/index']],
                    ...
                    [
                        'label' => 'ผู้ป่วยใน', 'icon' => 'cog text-orange', 
                        'items' => [
