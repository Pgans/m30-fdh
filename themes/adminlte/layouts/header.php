...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">Claim</span><span class="logo-lg"><div> M30-2Claim</div><span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						<img src="<?= './images/com002.jpg' ?> class="user-image" alt="User Image" />
