                ...
                'items' => [
                    ...
                    */
					[
                        ...
                        'items' => [
                            ['label' => 'F16-AN', 'icon' => 'fas fa-play text-aqua', 'url' => ['/f16visit/index']],
							['label' => 'F16-ช่วงเวลา', 'icon' => 'fas fa-play text-aqua', 'url' => ['/f16only/index']],
							['label' => 'ปิดสิทธิ์', 'icon' => 'fas fa-play text-aqua', 'url' => ['/closevisit/index']],
                        ],
                    ],
