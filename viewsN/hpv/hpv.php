...
<body>
            ...
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <div class="col-auto">
                                <a href="<?= \yii\helpers\Url::to(['/hpv/loghpv']) ?>" target="_blank">
                        ...
                        <div class="icon">
                            ...
                            <div class="col-auto">
                                <a href="<?= \yii\helpers\Url::to(['/hpv/logerr']) ?>" target="_blank">
                                    <a href="#" class="popup-link" data-url="<?= yii\helpers\Url::to(['/hpv/logerr']) ?>">
                                        <img src="images/accept.svg" title="ข้อมูลสำเร็จ" width="70" height="60">
                                    </a>
                            </div>
                            <!-- Modal -->
    ...
    <input name="btnButton1" class="btn btn-info btn btn-block" id="checkAll" type="submit" name="select" value="ส่งข้อมูล Moph-Claim HPV">
    ...
    <table class="table table-striped" width="1100" border="0">
        ...
        <?php
        foreach ($hpvProvider->getModels() as $key => $value) :
        ?>
            <tr>
                ...
                <td style="font-size: 14px;"><?php echo $value["lot_no"]; ?></div>
    ...
    <div class="box-footer with-border">
        <div class="col-md-12">
            <div class="form-group">
                <!-- <p> <?= Html::submitButton('ส่งข้อมูล HPV', ['class' => 'btn btn-success']) ?></p> -->
