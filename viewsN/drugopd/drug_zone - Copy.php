...
$data = [
    ['name' => '1111112222223333334444444555555', 'age' => 25, 'gender' => 'Male'],
...
echo ExportMenu::widget([
    ...
    ?>
<?php
//yii2  kartik-v/yii2-grid  export excel2007 in gridview
echo GridView::widget([
        'dataProvider' => $dataProvider,
        
         'panel' => [
             'before'=>'<b style="color:blue">การใช้ยา รพสต. ตามช่วงเวลา</b>',
             'after'=>'<b style="color:red">ประมวลผลจากวันที่ </b>'.$date1   .'<b style="color:red">ถึงวันที่</b>' .$date2 .'<b style="color:blue">::::::::จำนวนการเข้าใช้งาน:::::</b>' .$amount
           ],
               'columns' => [
                    ['class' => 'yii\grid\SerialColumn'],
