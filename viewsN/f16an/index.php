...
<br>
<div class="well">
    <div style="background-color: #8080ff; padding: 10px; border: 0px solid #D4F1F5; box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
        ...
        <div class="col-xl-3 col-md-5 mb-5">
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    <span class="info-box-text" style="color: green; font-size: 18px;">เลือกตาม AN 6 หลัก</span>
                ...
                <div class="icon">
                    ...
                    <div class="text-center">
                                <?php $form = ActiveForm::begin(['action' => ['f16an/data']]); ?>
                                <div class="row">
                                    <div class="col-md-4 offset-md-4"> <!-- Adjust the column width and offset as needed -->
                                        <?= Html::input('text', 'adm_id', '', ['class' => 'form-control', 'maxlength' => 10, 'style' => 'width:300px']) ?>
                                    </div>
                                    <div class="col-md-3">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="icon">
                    ...
                    <div class="text-center">
                        <a href="<?= \yii\helpers\Url::to(['f16an/exports']) ?>" class="btn btn-primary" style="font-size: 16px;">
                            Export Files <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
                    <div class="text-center">
                        <a href="<?= \yii\helpers\Url::to(['f16an/send']) ?>" class="btn btn-info" style="font-size: 16px;">
                            ส่ง FDH <i class="fa fa-arrow-circle-right"></i>
                        </a>
                    </div>
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="icon">
                    ...
                    <div class="text-center">
                        <a href="<?= \yii\helpers\Url::to(['f16fdhan/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
