...
<br>
<div class="well">
    <div style="background-color: #9b009b; padding: 10px; border: 0px solid #D4F1F5; box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
...
<script>
    $(document).ready(function(){
        ...
        <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล ANC-DENT" style="background-color: #9b009b; border: 4px solid #dadada;">
        ...
        <table class="table table-striped" width="1000" border="0">
            <tr>
                ...
                <td width="30" style="background-color: lightpink;">
