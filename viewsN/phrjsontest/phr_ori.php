...
?>
    ...
    setTimeout("frmMain.submit();",3000);
...
<div class="row">
        ...
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="col-auto">
                        <a href="<?= \yii\helpers\Url::to(['/phrjson/sendphr']) ?>" target="_blank">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="icon">
                        ...
                        <div class="col-auto">
                            <a href="<?= \yii\helpers\Url::to(['/phrjson/logerr']) ?>" target="_blank">
    ...
    <?=Html::beginForm(['phrjson/check'],'post',['name' => 'frmMain']);?> 
            ...
            <table class="table table-striped" width="1100" border="0">
                <tr>
                    ...
                    <td width="30">
                        <div align="center" style="font-size: 14px;"> #ปป </div>
                    </td>
                    <td width="30">
                ...
                <?php
                foreach ($dataPhr->getModels() as $key => $value) :
                ?>
                    <tr>
