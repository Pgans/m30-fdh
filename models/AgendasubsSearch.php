...
/**
 * AgendasubsSearch represents the model behind the search form of `app\models\Agendasubs`.
 */
class AgendasubsSearch extends Agendasubs
{
    /**
     * {@inheritdoc}
     */
