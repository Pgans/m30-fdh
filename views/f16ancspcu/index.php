...
$this->title = 'ANC-mBase-PCUม่วงสามสิบ';
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6">
            <div class="filter-section">
                <?php $form = ActiveForm::begin(['action' => ['f16ancspcu/index'], 'method' => 'post', 'options' => ['class' => 'form-inline']]); ?>
            ...
            <tbody>
                <?php foreach ($dataProvider->getModels() as $key => $value) : ?>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <span class="badge" style="background:#defced; color:#0b8a4f"><?= $value["hn"]; ?></span>
                        </td>
