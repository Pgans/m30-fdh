...
$this->title = 'FDH{OPD_นัดรากฟันเทียม}';
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        <a href="<?= Url::to(['f16implants/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
					   style="font-size: 16px; border-radius: 25px;">
						...
						<a href="<?= \yii\helpers\Url::to(['fdhimplants/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16implants/exports'], ['class' => 'btn btn-success']) ?>
                    </div>
                    </div>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 600px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16implants/data'], 'post', ['name' => 'frmMain']); ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
           ...
           <!-- <input name="btnButton1" class="btn btn-success btn btn-block btn-blink" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH OP-นัดรากฟันเทียม" style="background-color: #00a400; border: 4px solid #dadada; font-size: 16px; transition: all 0.3s;">
			-->
    ...
    <tbody>
        ...
        foreach ($dataProvider->getModels() as $key => $value) : 
            // ตรวจสอบว่าค่า Diag ซ้ำหรือไม่
            $diag = $value["Diag"];
            $duplicate = $diagCounts[$diag] > 1;
        ?>
           <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#f9edfc' : '#e4f7f0'); ?>;">
                <td>
                    <input type="checkbox" name="chkDel[]" id="chkDel<?= $i; ?>" value="<?php echo $value["visit_id"]; ?><?php echo $value["hn"]; ?>" style="width: 16px; height: 16px;"></td>
                </td>
