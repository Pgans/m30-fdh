...
<body>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div id="visitContainer" style="height: 125px; overflow-y: auto;"> <!-- สร้างพื้นที่ที่สามารถเลื่อน -->
                </div>
                ...
                <script>
                    ...
                    // ฟังก์ชันเพื่อแสดงรายการด้วยการหน่วงเวลาและจำกัดจำนวนแถวที่แสดง
                    function displayVisits(visits, delay, success) {
                        visits.forEach((visit, index) => {
                            setTimeout(() => {
                                const visitElement = document.createElement("div");
                                visitElement.innerHTML = `Seq:${visit} - Hn:${hn} - <span style="color: green;">${success}</span>`;
                                visitContainer.appendChild(visitElement);

                                // จำกัดจำนวนแถวที่แสดง
                                if (visitContainer.children.length > 5) { // ถ้าเกิน 5 แถว, ลบแถวแรก
                                    visitContainer.removeChild(visitContainer.firstChild);
                                }

                                // เลื่อนเมื่อมีรายการใหม่เพิ่มเข้ามา
                                visitContainer.scrollTop = visitContainer.scrollHeight; // เลื่อนไปยังจุดสูงสุดของ scrollbar
                            }, delay * (index + 1)); // หน่วงเวลา 500 มิลลิวินาทีสำหรับแต่ละรายการ
                        });
                    }

                    // เรียกฟังก์ชันด้วยการหน่วงเวลา 500 มิลลิวินาที
                    displayVisits(visits, 500, success); // หน่วงเวลา 500 มิลลิวินาที
                </script>
    ...
    <div class="page-container">
        ...
        <div style="height: 400px; overflow-y: auto;">
            ...
            <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH OPD" style="background-color: #00a400; border: 4px solid #dadada;">
