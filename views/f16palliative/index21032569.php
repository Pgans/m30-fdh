...
.my-striped-table tbody tr:hover {
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <input name="btnButton1" class="btn btn-success btn btn-block btn-blink" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล Palliative" style="background-color: #d6aafa; border: 4px solid #dadada; font-size: 20px; transition: all 0.3s;">
    ...
    <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["messagecode"]; ?></div></td>
