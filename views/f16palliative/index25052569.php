...
/* ===== BASE CARD ===== */
.fdh-card { border-radius: 16px; padding: 18px 18px 14px; position: relative; overflow: hidden; transition: transform .18s, box-shadow .18s; }
...
.fdh-card .card-btn { display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px; border-radius: 8px; font-size: 12px; font-weight: 600; text-decoration: none; border: none; cursor: pointer; transition: opacity .15s; white-space: nowrap; }
.fdh-card .card-btn:hover { opacity: .82; text-decoration: none; }

.card-all     { background: linear-gradient(135deg, #3b0764 0%, #6b21a8 100%); color: #f3e8ff; border: 1px solid #a855f7; }
.card-all     .card-btn { background: #d8b4fe; color: #2e1065; }
...
.card-search  input.form-control { background: rgba(255,255,255,.06) !important; border: 1px solid rgba(255,255,255,.15) !important; color: #e2e8f0 !important; border-radius: 8px !important; font-size: 12px !important; height: 32px !important; padding: 0 10px !important; }
.card-search  .btn-search { background: #a855f7; color: #fff; border: none; border-radius: 8px; padding: 6px 12px; font-size: 12px; font-weight: 600; cursor: pointer; width: 100%; margin-top: 4px; }
        ...
        <table class="fdh-table">
            ...
            ?>
                <tr class="<?= $rowCls ?>">
                    ...
                    <td style="font-size:12px;"><?= $value['hospsub'] ?></td>
