...
<style>
    ...
    .info-card {
        background: linear-gradient(135deg, #e0e0e0, #f5f5f5); /* ปรับเป็นสีเทาสว่างสดใส Gradient */
...
<div class="row">
    <div class="col-xl-3 col-md-12 mb-12">
        <div class="info-card" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);"> <span class="info-box-icon"><i class="far fa-calendar-check" style="color: green;"></i></span>
            ...
            <div style="text-align: right;">
                ...
                <a href="<?= Url::to(['f16opofc/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" class="btn btn-info" style="font-size: 16px; border-radius: 25px;">
                ...
                <?= Html::a('Export', ['f16opofc/exports'], ['class' => 'btn btn-success']) ?>
                    ...
                    <?= Html::beginForm(['f16opofc/data'], 'post', ['name' => 'frmMain', 'id' => 'formMains']); ?>
                        ...
                        ?>
                            <div class="floating-button" style="position: fixed; bottom: calc(3 * 2rem); left: 50%; transform: translateX(-50%); z-index: 1000;">
                                <button type="button" name="btnSubmit" id="btnSubmit" class="btn btn-success btn btn-block" style="border: 4px solid #dadada; padding: 10px 20px; border-radius: 30px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); font-size: 1.5rem; text-transform: uppercase; cursor: pointer; width: auto;">
                                    <i class="fa fa-arrow-circle-right" style="margin-right: 10px;"></i>
                                    ส่งข้อมูล OP-OFC สิทธิ์ข้าราชการ
                                </button>
                            </div>
                        <?php endif; ?>
