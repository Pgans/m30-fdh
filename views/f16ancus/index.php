...
$this->title = 'ระบบบริหารจัดการข้อมูล [f16ancus]';
...
<div class="anc-page-wrapper">
    ...
    <div class="anc-page-title">
       ...
       เงื่อนไข:: สิทธิ์บัตรทอง รหัสโรค 'Z348' และอุลตราซาวด์('8878') รองรับส่งหลายวัน
    </div>
    ...
    <div class="control-container">
        ...
        <div class="control-card card-teal">
            ...
            <a href="<?= Url::to(['f16ancus/run-curl']) ?>" class="pill-btn pill-teal">
    ...
    <div class="quick-links-bar">
        ...
        <?= Html::a('<i class="fa fa-window-restore"></i> Query ในหน้านี้ (Modal)', '#', [
            ...
            'data-url' => Url::to(['/fdhancus/index']),
        ]) ?>
        
        <span class="sep">|</span>
        <a href="<?= Url::to(['f16ancus/exports', 'date1' => $date1, 'date2' => $date2]) ?>" class="ql-success">
            <i class="fa fa-file-excel-o"></i> Export Excel
        </a>
    </div>

    <?= Html::beginForm(['f16ancus/data'], 'post', ['name' => 'frmMain']) ?>
    ...
    ?>
        <div class="floating-container">
            <?= Html::submitButton(
                '<i class="fa fa-paper-plane"></i> ส่งข้อมูล [ANC-US]',
...
<?php $this->registerJs(
    ...
    "var _url     = '" . Url::to(['f16ancus/check']) . "';",
...
// ═══ 2. MODAL ใหม่สำหรับแสดงหน้าต่าง QUERY ระบบ fdhancus═══
Modal::begin([
    'id'     => 'queryDataModal',
    'header' => '<h4 style="font-weight:700;color:#6c48ff;margin:0;"><i class="fa fa-window-restore"></i> ข้อมูลระบบตรวจสอบแผนกเดนท์ [fdhancus]</h4>',
    'size'   => Modal::SIZE_LARGE,
]);
