...
<body>
    ...
    <h4><a>เงื่อนไข:: </a> สิทธิ์บัตรทอง รหัสโรค Z348  และ Lab1</h4>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <a href="<?= Url::to(['f16anclab1/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16anclab1/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhanclab1/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16anclab1/exports'], ['class' => 'btn btn-success']) ?>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); width: 350px; height: 140px;">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-3">
                            <?php $form = ActiveForm::begin(['action' => ['f16anclab1/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div style="height: 400px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16anclab1/data'], 'post', ['name' => 'frmMain']); ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
            ...
            <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" value="ส่งข้อมูล FDH ANC-LAB1" style="background-color: #00b8c1; color: #FFFFFF; border: none; font-size: 16px; padding: 10px 20px; transition: all 0.3s;">
