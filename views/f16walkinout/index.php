...
$this->title = 'FDH{OPD_Walkin นอกจังหวัด}';
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                       ...
                       <a href="<?= Url::to(['f16walkinout/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
					   style="font-size: 16px; border-radius: 25px;">
						...
						<a href="<?= \yii\helpers\Url::to(['fdhwalkinout/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16walikinout/exports'], ['class' => 'btn btn-success']) ?>
                    </div>
                    </div>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16walkinout/data'], 'post', ['name' => 'frmMain']); ?>
		...
		?>
			...
			<div class="floating-button" 
				...
				<button type="submit" 
					...
					ส่งข้อมูล OP-Walkin นอกจังหวัด
				</button>
			</div>
		<?php endif; ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
           ...
           <!-- <input name="btnButton1" class="btn btn-success btn btn-block btn-blink" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH OP-Walkin นอกจังหวัด" style="background-color: #00a400; border: 4px solid #dadada; font-size: 20px; transition: all 0.3s;">-->
    ...
    <thead>
        <tr>
            ...
            <th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
                <div align="left" style="font-size: 14px;">สถานพยาบาล</div>
            </th>
			 <th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
    ...
    <tbody>
        ...
        <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#F2DEF9' : '#d4f4e8'); ?>;">
            ...
            <td class="text-nowrap" style="font-size: 14px;">
				<?= mb_strlen($value["hospname"], 'UTF-8') > 30 
					? mb_substr($value["hospname"], 0, 30, 'UTF-8') . '...' 
					: $value["hospname"] ?>
			</td>

			<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["amount"]; ?></td>
			<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["paid"]; ?></td>
            <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["messagecode"]; ?></td>
			<td class="text-nowrap" style="font-size: 14px; color: <?= $value["amount"] == 0 ? 'red' : 'green' ?>;">
				<?= $value["amount"]; ?>
			</td>
