...
$this->title = 'OP-ฝัง-ถอนยาคุมกำเนิด';
...
.my-striped-table tbody tr:hover {
    ...
    <h4 style="background-color: #ffffff; padding: 10px; border-radius: 5px;">
    <a>เงื่อนไข:: </a>
    icd10 = ฝังZ308, ถอนZ304 ดึงจากการใช้ยา '2376'=Implant EtoNorgestrel , 8605  เป็นคนไทย 
    สิทธิ์บัตรทอง  ('03','04','33') Type = 3 CODE= FP002_1 ราคา 2150 บาท, FP002_2 ราคา 350 บาท
</h4>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16optonpills/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16optonpills/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhoptonpills/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                       <?= Html::a('Export', ['f16optonpills/exports'], ['class' => 'btn btn-success']) ?>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16optonpills/data'], 'post', ['name' => 'frmMain']); ?>
			...
			?>
				...
				<div class="floating-button" 
					...
					<button type="submit" 
						...
						ส่งข้อมูล OP-ฝัง-ถอนยาคุมกำเนิด
					</button>
				</div>
			<?php endif; ?>
...
<script>
    ...
    id="selectAll" 
    type="submit" 
    value="ส่งข้อมูล OP-ฝัง-ถอนยาคุมกำเนิด" 
    style="background-color: #d4f4e8; 
