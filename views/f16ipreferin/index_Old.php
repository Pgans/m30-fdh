...
<body>
    ...
    <div class="row">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['f16ipnormal/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
        ...
        <a href="javascript:void(0);" id="exportExcelButton" class="btn btn-primary" style="font-size: 16px; border: 4px solid #91ffff;" onclick="openPopup();">
            รายชื่อและส่งออก ExcelFiles <i class="fa fa-arrow-circle-right"></i>
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhipnormal/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <a href="<?= \yii\helpers\Url::to(['f16ipnormal/exports']) ?>" class="btn btn-primary" style="font-size: 16px;">
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-3">
                            <?php $form = ActiveForm::begin(['action' => ['f16ipnormal/index']]); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <a href="<?= Url::to(['f16ipnormal/run-curl']) ?>" class="btn btn-primary" style="font-size: 16px;">
    ...
    <div class="page-container">
        ...
        <div style="height: 400px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16ipnormal/data'], 'post', ['name' => 'frmMain']); ?>

            <!-- <form id="checkbo" name="frmMain" action="index" method="post"> -->
            <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล IP Normal" style="background-color: #00a400; border: 4px solid #dadada; font-size: 28px;">
