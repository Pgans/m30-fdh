...
<style>
    ...
    <style>
	 ...
	 <style>
        .info-card {
            background: linear-gradient(45deg, #b8abf5, #d3fbf5); /* Canva-like gradient */
...
.my-striped-table tbody tr:hover {
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['f16ipreferin/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
 ...
 <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
               <a href="<?= Url::to(['f16ipreferin/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
								   class="btn btn-info" 
        ...
        <a href="javascript:void(0);" id="exportExcelButton" class="btn btn-primary" style="font-size: 16px; border: 4px solid #91ffff;" onclick="openPopup();">
            รายชื่อและส่งออก ExcelFiles <i class="fa fa-arrow-circle-right"></i>
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhipreferin/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16ipreferin/exports'], ['class' => 'btn btn-info']) ?>
...
<br>
    ...
    <div style="height: 600px; overflow-y: auto;">
        ...
        <?= Html::beginForm(['f16ipreferin/data'], 'post', ['name' => 'frmMain']); ?>
...
<div style="padding: 15px; background: linear-gradient(to right, #f4e9f7, #b0e2d6); border: 1px solid #ddd; margin-bottom: 20px; display: flex; align-items: center;">
...
?>
    ...
    <div class="floating-button" 
        ...
        <button type="submit" 
            ...
            ส่งข้อมูล IP-REFERIN
        </button>
    </div>
<?php endif; ?>

     <!--<input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล IP REFERIN" style="background: linear-gradient(45deg, #14a837, #0ecf3c); border: 4px solid #dadada; font-size: 20px; color: white; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
        -->
    <style>
    .my-striped-table {
        width: 100%;
    ...
    .my-striped-table th, .my-striped-table td {
    ...
    /* ตรึงหัวตาราง */
    .my-striped-table thead tr th {
        position: sticky;
        top: 0;
        background: linear-gradient(to right, #d3d3d3, #a9a9a9); /* สีเทา */
        color: black;
        z-index: 10;
    }

    /* เปลี่ยนสีพื้นหลังแถว */
