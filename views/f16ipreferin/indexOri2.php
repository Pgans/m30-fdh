...
<style>
    ...
    <style>
	 ...
	 <style>
        .info-card {
            background: linear-gradient(45deg, #d4f4e8, #b0e2d6); /* Canva-like gradient */
...
.my-striped-table tbody tr:hover {
 ...
 <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16ipreferin/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); width: 350px; height: 140px;">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-3">
                            <?php $form = ActiveForm::begin(['action' => ['f16ipreferin/index']]); ?>
    ...
    <button type="submit" 
     ...
     <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล IP REFERIN" style="background: linear-gradient(45deg, #14a837, #0ecf3c); border: 4px solid #dadada; font-size: 20px; color: white; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse;">
             <td width="30" style="background: linear-gradient(to right, #d4f4e8, #b0e2d6);">
                <div align="center">
