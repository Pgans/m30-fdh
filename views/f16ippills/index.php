...
<style>
 ...
 <style>
        .info-card {
            background: linear-gradient(45deg, #d4f4e8, #b0e2d6); /* Canva-like gradient */ เขียวอ่อน
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
               <a href="<?= Url::to(['f16ippills/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
								   class="btn btn-info" 
        ...
        <a href="javascript:void(0);" id="exportExcelButton" class="btn btn-primary" style="font-size: 16px; border: 4px solid #91ffff;" onclick="openPopup();">
            รายชื่อและส่งออก ExcelFiles <i class="fa fa-arrow-circle-right"></i>
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhippills/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
...
<br>
    ...
    <div class="page-container">
        <div class="fixed-header">
            <!-- <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH pillls " style="background-color: #b605cf; border: 4px solid #dadada;"> -->
        </div>
        ...
        <div id="loading-spinner" style="display: none;">
            ...
            <?= Html::beginForm(['f16ippills/data'], 'post', ['name' => 'frmMain']); ?>
...
?>
    ...
    <div class="floating-button" 
        ...
        <button type="submit" 
            ...
            ส่งข้อมูล IPD ฝังยาคุมกำเนิด
        </button>
    </div>
<?php endif; ?>
		

          <!-- <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล IPD ฝังยาคุม" style="background-color: #00a400; border: 4px solid #dadada;">-->
    ...
    <thead>
        <tr>
            ...
            <th width="30" style="background-color: lightgray; position: sticky; top: 0; z-index: 1;">
                <div align="left" style="font-size: 14px;">ราคาเบิก</div>
            </th>
            <th width="30" style="background-color: lightgray; position: sticky; top: 0; z-index: 1;">
    ...
    <tbody>
        ...
        <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#F2DEF9' : '#d4f4e8'); ?>;">
            ...
            <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["amountx"]; ?></td>
