...
.my-striped-table tbody tr:hover {
    ...
    <h4><a>เงื่อนไข:: </a> สิทธิ์บัตรทอง รหัสโรค 'Z348' </h4>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
				...
				<div style="text-align: right;">
                <a href="<?= Url::to(['f16ancdentlab1/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16ancdentlab1/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhancdentlab1/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16ancdentlab1/exports'], ['class' => 'btn btn-success']) ?>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16ancdentlab1/data'], 'post', ['name' => 'frmMain']); ?>
...
?>
    ...
    <div class="floating-button" 
        ...
        <button type="submit" 
                ...
                style="background-color: #22bdbd; border: 4px solid #dadada; padding: 10px 20px; 
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
            ...
            <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
                ...
                <td width="30" style="background-color: lightgray;">
                    <div align="left" style="font-size: 14px;">claim_anc
                </td>
                <td width="30" style="background-color: lightgray;">
    ...
    <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["claim_code"]; ?></div>
    </td>
