...
$this->title = 'ระบบบริหารจัดการข้อมูล [FDH-ANC-DENT-LAB1]';
...
<div class="anc-page-wrapper">
    ...
    <div class="control-container">
        ...
        <div class="control-card card-teal">
            ...
            <a href="<?= Url::to(['f16ancdentlab1/run-curl']) ?>" class="pill-btn pill-teal">
    ...
    <div class="quick-links-bar">
        ...
        <span class="sep">|</span>
        <a href="<?= Url::to(['f16ancdentlab1/exports', 'date1' => $date1, 'date2' => $date2]) ?>" class="ql-success">
    ...
    ?>
        <div class="floating-container">
            <?= Html::submitButton(
                '<i class="fa fa-paper-plane"></i> ส่งข้อมูล f16-anc-dentlab1',
...
<?php $this->registerJs(
    ...
    "var _url     = '" . Url::to(['f16ancdentlab1/check']) . "';",
...
// ═══ 2. MODAL ใหม่สำหรับแสดงหน้าต่าง QUERY ระบบ f16ancdentlab1 ═══
Modal::begin([
    'id'     => 'queryDataModal',
