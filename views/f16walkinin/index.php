...
$this->title = 'FDH{OPD_walkinในจังหวัด}';
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        <a href="<?= Url::to(['f16walkinin/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
					   style="font-size: 16px; border-radius: 25px;">
						RunToken <i class="fa fa-arrow-circle-right"></i>
				    	</a>
                                    <a href="<?= \yii\helpers\Url::to(['fdhwalkinin/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16walkinin/exports'], ['class' => 'btn btn-success']) ?>
                    </div>
                    </div>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16walkinin/data'], 'post', ['name' => 'frmMain']); ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
          ...
          <!-- <input name="btnButton1" class="btn btn-success btn btn-block btn-blink" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH OP-WALKIN ในจังหวัด" style="background-color: #00a400; border: 4px solid #dadada; font-size: 16px; transition: all 0.3s;">-->
...
<table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
    <thead>
        <tr>
            <th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 2;">
                <div align="center">
            ...
            <th width="150" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 2;">
    ...
    <tbody>
        ...
        <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#f5e6fa' : '#daf7ef'); ?>;">
