...
$this->title = 'FDH-ANCDENT-US-Lab2';
...
<body>
   ...
   <style>
    ...
    <h4><a>เงื่อนไข:: </a> สิทธิ์บัตรทอง รหัสโรค Z348 หัตถการทำฟัน 2387010, 2330011 อุลตราซาวด์ 88.78 และ Lab2</h4>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <a href="<?= Url::to(['f16ancdentuslab2/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16ancdentuslab2/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhancdentuslab2/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16ancdentuslab2/exports'], ['class' => 'btn btn-success']) ?>
                </div>
            </div>
        </div>
            ...
            <th width="30" style="background-color: lightgray; position: sticky; top: 0; z-index: 1;">
               ...
               <td width="30" style="background-color: lightgray;position: sticky; top: 0; z-index: 1;">
                ...
                <?php foreach ($dataProvider->getModels() as $key => $value) : ?>
                    <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#F2DEF9' : '#d7f5e6'); ?>;">
						...
						<td  style="font-size: 14px;"><?php echo $value["labId"]; ?></td>
