...
<div class="btn-group-modern">
    ...
    <a href="<?= Url::to(['/totalvisits/index']) ?>" class="btn-modern btn-opd">
        <i class="fa fa-check-square-o"></i> Total Visits
    </a>
...
">
        ...
        <?= Html::beginForm(['totalvisits/check'], 'post', ['name' => 'frmMain']); ?>

        <!-- <form id="checkbo" name="frmMain" action="index" method="post"> -->
        <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH Total Visits" style="background-color: #fb5200; border: 4px solid #dadada;">
        ...
        <table class="table table-striped" width="1000" border="0">
            <tr>
                ...
                <td width="30" style="background-color: lightgray;">
				 ...
				 <td width="30" style="background-color: lightgray;">
                    <div align="center" style="font-size: 14px;"> ลงทะเบียน </div>
                </td>
	...
	<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["time_start"]; ?></div>
    </td>
...
<?php 
echo Html::beginForm(['totalvisits/delete-multiple'], 'post'); // เริ่มต้นฟอร์ม POST สำหรับ multi-delete
