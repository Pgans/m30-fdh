...
$this->title = 'JHCIS-เยี่ยมหลังคลอด';
...
<br>
	...
	<style>
        .info-card {
            background: linear-gradient(45deg, #b0e2d6 , #d6aafa); /* Canva-like gradient */
...
.my-striped-table tbody tr:hover {
    ...
    <h4><a>เงื่อนไข:: </a> สิทธิ์บัตรทอง 10953  รหัสโรค ('z340','z348') 7แฟ้ม['adp', 'ins', 'odx', 'opd', 'pat', 'cha', 'cht'] </h4> 
	<h5><a>200.70::jhcisdb </a> Copy [visitanc, person, cdrug, mathhn, visit,visitancpregnancy ,userx ] Procedure--fdhanc_care </h5>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16janccare/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16janccare/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhjanccare/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                     <a href="<?= Url::to(['personcopy/copyanccare']) ?>" class="btn btn-info" style="font-size: 16px;">
    ...
    <div class="row justify-content-center">
        <div class="col-md-3">
        <?php $form = ActiveForm::begin(['action' => ['f16janccare/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16janccare/data'], 'post', ['name' => 'frmMain']); ?>
...
<script>
        ...
        document.addEventListener("mouseup", () => {
            ...
            <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
             ...
             <td width="30" style="background-color: #b0e2d6;">
                ...
                <td width="30" style="background-color: #b0e2d6;">
                    <div align="left" class="text-nowrap" style="font-size: 14px;"> ระยะห่างวัน </div>
                </td>
    ...
    <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["ห่างวัน"]; ?></div>
    </td>
