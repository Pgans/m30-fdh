...
">
                ...
                <div style="text-align: right;">
                <a href="<?= Url::to(['closevisit/run-curl']) ?>" class="btn btn-lightwarning" style="font-size: 16px;">
...
">
        ...
        <table class="table table-striped" width="1000" border="0">
            <tr>
                ...
                <td width="30" style="background-color: lightgray;">
				 ...
				 <td width="30" style="background-color: lightgray;">
                    <div align="center" style="font-size: 14px;"> สิ้นสุด </div>
                </td>
                <td width="30" style="background-color: lightgray;">
    ...
    <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["time_end"]; ?></div>
    </td>
