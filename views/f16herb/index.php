...
$this->title = 'FDH-HERB สมุนไพรไทย';
...
.my-striped-table tbody tr:hover {
    ...
    <br>
	เปลี่ยนยาแก้ไอมะขามป้อม 2280 =60 Ml เป็น 2443 =120 Ml  ราคา 27.90 บาท   <a>2486 =ครีมไพล (Herb5) ราคา 40.77 บาท ***** 2503=ยาอมประสะมะแว้ง ราคา 5.28 บาท</a>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16herb/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
            ...
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhhurb/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                       ...
                       <?= Html::a('Export', ['f16herb/exports'], ['class' => 'btn btn-success']) ?>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16herb/data'], 'post', ['name' => 'frmMain']); ?>
