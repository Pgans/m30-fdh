...
<style>
    /* จำกัดสูงสุดให้เลื่อนแค่ 18 แถว */
    .panel-custom {
        max-height: calc(18 * 35px); /* 35px = ความสูงแต่ละแถว (ปรับได้) */
        overflow-y: auto;
    }
    ...
    /* ตารางที่มี hover สี #cef0f0 */
    .my-striped-table tbody tr:hover {
        background-color: #cef0f0 !important;
        transition: background-color 0.2s ease-in-out;
    }

    /* ปรับ scrollbar ให้ดูสวย */
    .panel-custom::-webkit-scrollbar {
        width: 8px;
    }

    .panel-custom::-webkit-scrollbar-thumb {
        background: #b0e2d6;
        border-radius: 4px;
    }

    .panel-custom::-webkit-scrollbar-track {
        background: #f1f1f1;
    }
</style>
    <!-- ############################# แสดงปุ่ม Select All  ################################################################### -->
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <?= Html::a('Export', ['f16rider/exports'], ['class' => 'btn btn-success']) ?>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-3 mb-3">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
            ...
            <table class="table my-striped-table" width="1000" border="1" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);position: sticky; top: 0; z-index: 1;">

                <th width="30" style="background-color: #b0e2d6;position: sticky; top: 0; z-index: 1;">
                    <div align="center">
                        <input name="CheckAll" type="checkbox" id="CheckAll" value="Y" onClick="ClickCheckAll(this);">

                    </div>
                <td width="30" style="background-color: #b0e2d6;position: sticky; top: 0; z-index: 1;">
                ...
                <td width="150" style="background-color: #b0e2d6;position: sticky; top: 0; z-index: 1;">
				...
				<td width="30" style="background-color: #b0e2d6;position: sticky; top: 0; z-index: 1;">
                    <div align="left" style="font-size: 14px;">SBP </div>
                </td>
				<td width="30" style="background-color: #b0e2d6;position: sticky; top: 0; z-index: 1;">
                    <div align="left" style="font-size: 14px;">DBP </div>
                </td>
				<td width="30" style="background-color: #b0e2d6;position: sticky; top: 0; z-index: 1;">
                    <div align="left" style="font-size: 14px;">FBS </div>
                </td>
               ...
               <?php foreach ($dataProvider->getModels() as $key => $value) : ?>
                    ...
                    <tr style="background-color: <?= empty($value['messagecode']) ? '#f7edfa' : '#ebfaf4'; ?>; font-weight: normal; font-family: Tahoma, Arial, Kanit, sans-serif; font-size: 14px;">
					...
					<td style="font-size: 14px; color: <?= $fontColor ?>;">
						...
						<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["SBP"]; ?></td>
						<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["DBP"]; ?></td>
						<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["FBS"]; ?></td>
