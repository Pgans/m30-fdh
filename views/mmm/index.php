...
$this->title = 'รายงานศูนย์จัดเก็บรายได้ TripMMM';
?>
...
/* สไตล์สำหรับปุ่ม */
.btn-success {
    background: linear-gradient(45deg, #76c7f0, #4fa3e3, #3282b8); /* ใช้ gradient */
    border: none;
    color: white;
    padding: 10px 20px;
    font-size: 16px;
...
.grid-view th {
    ...
    color: #000; /* เปลี่ยนสีฟอนต์เป็นสีดำ */
    padding: 12px;
    text-align: center;
    font-weight: bold;
...
.gradient-bg {
    background: linear-gradient(45deg, #76c7f0, #4fa3e3, #3282b8);
    border-radius: 15px;
    padding: 20px;
...
.gradient-bg:hover {
    background: linear-gradient(45deg, #5ab1e2, #3d92d6, #2c72a5);
...
<div class="col-xl-3 col-md-2">
    <div class="card border-primary shadow-lg h-100 py-2">
           ...
           <div class="well" style="background: linear-gradient(45deg, #fcfced, #b0e2d6);">
