...
.my-striped-table tbody tr:hover {
    ...
    <h4><a>เงื่อนไข:: </a> สิทธิ์บัตรทอง 10953 คนไทย </h4>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16upt/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16upt/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhupt/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16upt/exports'], ['class' => 'btn btn-success']) ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-3">
        <?php $form = ActiveForm::begin(['action' => ['f16upt/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16upt/data'], 'post', ['name' => 'frmMain']); ?>
			<?php
...
<div class="page-container">
    ...
    <div style="height: 500px; overflow-y: auto;">
        ...
        ?>
            <div class="floating-button"
                 style="position: fixed; bottom: calc(3 * 2rem); left: 50%; transform: translateX(-50%); z-index: 1000;">
        ...
        <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd"
            ...
            <tr>
                ...
                <td width="30" style="background-color: lightgray;"><div align="center">#</div></td>
                <td width="30" style="background-color: lightgray;"><div align="center" style="font-size:14px;">วันที่</div></td>
                <td width="30" style="background-color: lightgray;"><div align="center" style="font-size:14px;">เลขบริการ</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" style="font-size:14px;">Hn</div></td>
                <td width="150" style="background-color: lightgray;"><div align="left" style="font-size:14px;">ชื่อ-สกุล</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" style="font-size:14px;">อายุ</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" style="font-size:14px;">แผนก</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" style="font-size:14px;">โรคหลัก</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" style="font-size:14px;">รหัสโรค</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" class="text-nowrap" style="font-size:14px;">สิทธิ์</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" class="text-nowrap" style="font-size:14px;">LAB</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" style="font-size:14px;">สถานหลัก</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" style="font-size:14px;">สถานรอง</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" style="font-size:14px;">สถานะ</div></td>
                <td width="30" style="background-color: lightgray;"><div align="left" style="font-size:14px;">authen</div></td>
                <!-- ✅ คอลัมน์ตรวจสอบ -->
                <td width="85" style="background-color: lightgray; text-align:center;">
...
<!-- ====================================================
     CSS — เหมือน Palliative แต่สีน้ำเงิน
     ==================================================== -->
<style>
/* ✅ 80vw เหมือน Palliative */
#modalCheckUpt .modal-dialog {
    max-width: 80vw;
    width: 80vw;
    margin: 20px auto;
}
#modalCheckUpt .modal-content { border-radius: 10px; overflow: hidden; border: none; }
#modalCheckUpt .modal-header  {
    background: linear-gradient(135deg, #185FA5 0%, #0c3d6e 100%);
    border-bottom: none;
    padding: 14px 18px;
}
#modalCheckUpt .modal-footer {
    background: #f9f9f9;
    border-top: 1px solid #e5e5e5;
    padding: 10px 18px;
}
#umdBody { max-height: 75vh; overflow-y: auto; padding: 16px 18px; }

.uchk-sum-row  { display: flex; gap: 10px; margin-bottom: 16px; }
.uchk-sum-card { flex: 1; border-radius: 10px; padding: 14px 16px; display: flex; align-items: center; gap: 12px; }
.ucsc-ok    { background: #E1F5EE; }
.ucsc-empty { background: #FCEBEB; }
.ucsc-na    { background: #F1EFE8; }
.ucsc-icon  { width: 36px; height: 36px; border-radius: 9px; display: flex; align-items: center; justify-content: center; font-size: 17px; font-weight: 700; flex-shrink: 0; }
.ucsc-ok    .ucsc-icon { background: #9FE1CB; color: #085041; }
.ucsc-empty .ucsc-icon { background: #F7C1C1; color: #791F1F; }
.ucsc-na    .ucsc-icon { background: #D3D1C7; color: #444441; }
.ucsc-num { font-size: 26px; font-weight: 700; line-height: 1; }
.ucsc-ok    .ucsc-num { color: #0F6E56; }
.ucsc-empty .ucsc-num { color: #A32D2D; }
.ucsc-na    .ucsc-num { color: #5F5E5A; }
.ucsc-lbl { font-size: 11px; font-weight: 500; margin-top: 3px; }
.ucsc-ok    .ucsc-lbl { color: #1D9E75; }
.ucsc-empty .ucsc-lbl { color: #E24B4A; }
.ucsc-na    .ucsc-lbl { color: #888780; }

.ufile-row { border: 1px solid #e4e4e4; border-radius: 8px; margin-bottom: 6px; overflow: hidden; transition: box-shadow 0.15s; }
.ufile-row:hover { box-shadow: 0 2px 6px rgba(0,0,0,0.07); }
.ufile-header { display: flex; align-items: center; gap: 10px; padding: 10px 14px; user-select: none; transition: background 0.1s; }
.ufile-header.clickable { cursor: pointer; }
.ufile-header.clickable:hover { background: rgba(0,0,0,0.02); }
.ufh-ok    { border-left: 4px solid #1D9E75; }
.ufh-empty { border-left: 4px solid #E24B4A; }
.ufh-na    { border-left: 4px solid #B4B2A9; }
.ufh-warn  { border-left: 4px solid #EF9F27; }
.ufile-name { font-size: 13px; font-weight: 600; min-width: 60px; color: #333; }
.ureq-star  { color: #E24B4A; font-size: 12px; }
.ufpill { font-size: 11px; font-weight: 500; padding: 3px 11px; border-radius: 20px; }
.ufpill-ok    { background: #E1F5EE; color: #0F6E56; }
.ufpill-empty { background: #FCEBEB; color: #A32D2D; }
.ufpill-na    { background: #F1EFE8; color: #5F5E5A; }
.ufpill-warn  { background: #FAEEDA; color: #633806; }
.ufchev { margin-left: auto; font-size: 11px; color: #bbb; transition: transform 0.2s; }
.ufile-row.open .ufchev { transform: rotate(180deg); }
.ufile-body { display: none; border-top: 1px solid #eee; }
.ufile-row.open .ufile-body { display: block; }

.udtbl { width: 100%; border-collapse: collapse; font-size: 11px; }
.udtbl th { background: #e8f0fb; padding: 5px 10px; text-align: left; border-bottom: 1px solid #e5e5e5; color: #185FA5; font-size: 10px; font-weight: 600; white-space: nowrap; text-transform: uppercase; letter-spacing: 0.03em; }
.udtbl td { padding: 5px 10px; border-bottom: 1px solid #f0f0f0; color: #333; white-space: nowrap; }
.udtbl tr:last-child td { border-bottom: none; }
.udtbl tbody tr:hover td { background: #f5f8ff; }

.uchk-prog-bar  { height: 5px; background: rgba(255,255,255,0.3); border-radius: 3px; overflow: hidden; margin-bottom: 14px; }
.uchk-prog-fill { height: 100%; background: #fff; border-radius: 3px; transition: width 0.25s; width: 0%; }

.uchk-err-box { background: #FCEBEB; border: 1px solid #F7C1C1; border-radius: 8px; padding: 12px 14px; color: #791F1F; font-size: 13px; }
.uchk-alert { border-radius: 8px; padding: 10px 14px; font-size: 13px; font-weight: 500; margin-bottom: 14px; display: flex; align-items: center; gap: 8px; }
.uchk-alert-ok    { background: #E1F5EE; color: #0F6E56; border: 1px solid #9FE1CB; }
.uchk-alert-error { background: #FCEBEB; color: #A32D2D; border: 1px solid #F7C1C1; }
</style>
...
<!-- ====================================================
     MODAL
     ==================================================== -->
<div class="modal fade" id="modalCheckUpt" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
                ...
                <div style="display:flex; align-items:center; gap:11px;">
                    ...
                    <div>
                        <div style="font-size:15px; font-weight:600; color:#fff;">
                            ตรวจสอบข้อมูล OP-UPT — 7 แฟ้ม
                        </div>
                        <div id="umdPatientInfo" style="font-size:11px; color:rgba(255,255,255,0.8); margin-top:2px;"></div>
                    </div>
                </div>
            ...
            <div id="umdBody">
                ...
                <div id="umdProgress" style="display:none; margin-bottom:6px;">
                    <div class="uchk-prog-bar">
                        <div class="uchk-prog-fill" id="umdProgFill"></div>
                    </div>
                ...
                <div id="umdAlert" style="display:none;"></div>

                <div id="umdSummary" style="display:none; margin-bottom:14px;">
                    <div class="uchk-sum-row">
                        <div class="uchk-sum-card ucsc-ok">
                            <div class="ucsc-icon">&#10004;</div>
                            <div><div class="ucsc-num" id="umdOkCount">0</div><div class="ucsc-lbl">มีข้อมูล</div></div>
                        </div>
                        <div class="uchk-sum-card ucsc-empty">
                            <div class="ucsc-icon">&#10008;</div>
                            <div><div class="ucsc-num" id="umdEmptyCount">0</div><div class="ucsc-lbl">ไม่มีข้อมูล</div></div>
                        </div>
                        <div class="uchk-sum-card ucsc-na">
                            <div class="ucsc-icon">&mdash;</div>
                            <div><div class="ucsc-num" id="umdNaCount">0</div><div class="ucsc-lbl">ไม่บังคับ</div></div>
                        </div>
                    </div>
                </div>
...
var uptCheckUrl = '<?= \yii\helpers\Url::to(['check-data']) ?>';

function openCheckModal(visit, hn, name) {
    $('#umdPatientInfo').html('<b>HN:</b> ' + hn + '&nbsp;|&nbsp;<b>Visit:</b> ' + visit + '&nbsp;|&nbsp;' + name);
    $('#umdGrid').html('');
    $('#umdAlert').hide().html('');
    $('#umdSummary').hide();
    $('#umdProgress').show();
    $('#umdProgFill').css('width', '0%');
    $('#modalCheckUpt').modal('show');

    var pct = 0;
    var pTimer = setInterval(function () {
        pct += 7;
        if (pct > 88) { clearInterval(pTimer); pct = 88; }
        $('#umdProgFill').css('width', pct + '%');
    }, 70);

    $.getJSON(uptCheckUrl, { visit: visit, hn: hn })
        .done(function (res) {
            clearInterval(pTimer);
            $('#umdProgFill').css('width', '100%');
            setTimeout(function () { $('#umdProgress').hide(); }, 300);
            renderUptFiles(res);
        })
        .fail(function (jqXHR) {
            clearInterval(pTimer);
            $('#umdProgress').hide();
            $('#umdGrid').html(
                '<div class="uchk-err-box"><i class="fas fa-exclamation-triangle"></i>&nbsp;เกิดข้อผิดพลาด HTTP <b>' + jqXHR.status + '</b></div>'
            );
        });
}

function renderUptFiles(res) {
    if (!res.success) {
        $('#umdGrid').html(
            '<div class="uchk-err-box"><i class="fas fa-exclamation-triangle"></i>&nbsp;<b>[Error]</b> ' + res.message +
            (res.file ? '<br><small>' + res.file + ' line ' + res.line + '</small>' : '') + '</div>'
        );
        return;
    }
    ...
    $.each(res.data, function (_, item) {
        ...
        if (item.status === 'ok') {
            hCls = 'ufh-ok';    pCls = 'ufpill-ok';    icon = '&#10004;'; label = 'มี ' + item.count + ' record'; ok++;
        } else if (item.status === 'empty') {
            hCls = 'ufh-empty'; pCls = 'ufpill-empty';  icon = '&#10008;'; label = 'ไม่มีข้อมูล!'; empty++;
        } else if (item.status === 'error') {
            hCls = 'ufh-warn';  pCls = 'ufpill-warn';   icon = '&#9888;';  label = 'Query Error'; empty++;
        } else if (item.status === 'no_config') {
            hCls = 'ufh-warn';  pCls = 'ufpill-warn';   icon = '&#9881;';  label = 'ไม่มี config'; empty++;
        } else {
            hCls = 'ufh-na';    pCls = 'ufpill-na';     icon = '&mdash;'; label = 'ไม่บังคับ'; na++;
        }

        var reqBadge = item.required ? '<span class="ureq-star"> *</span>' : '';
        var msgSpan  = item.message  ? '<span style="font-size:10px;color:#aaa;margin-left:6px;">(' + item.message + ')</span>' : '';

        var tblHtml = buildUptDataTable(item.rows);
        var hasData = (tblHtml !== '');

        html +=
            '<div class="ufile-row' + (item.status === 'empty' ? ' open' : '') + '">' +
            '  <div class="ufile-header ' + hCls + (hasData ? ' clickable' : '') + '"' +
               (hasData ? ' onclick="toggleURow(this)"' : '') + '>' +
            '    <span class="ufile-name">' + item.table + reqBadge + '</span>' +
            '    <span class="ufpill ' + pCls + '">' + icon + '&nbsp;' + label + '</span>' +
                 msgSpan +
            (hasData ? '<span class="ufchev">&#9660;</span>' : '') +
            '  </div>' +
            (hasData ? '<div class="ufile-body"><div style="overflow-x:auto;">' + tblHtml + '</div></div>' : '') +
            '</div>';
    });

    $('#umdGrid').html(html);
    $('#umdOkCount').text(ok);
    $('#umdEmptyCount').text(empty);
    $('#umdNaCount').text(na);
    $('#umdSummary').fadeIn(200);

    if (res.hasError) {
        $('#umdAlert').html('<i class="fas fa-times-circle"></i>&nbsp;ข้อมูลไม่ครบ — กรุณาตรวจสอบแฟ้มสีแดงก่อนส่ง')
            .removeClass('uchk-alert-ok').addClass('uchk-alert uchk-alert-error').show();
    } else {
        $('#umdAlert').html('<i class="fas fa-check-circle"></i>&nbsp;ข้อมูลครบถ้วน — พร้อมส่งข้อมูล')
            .removeClass('uchk-alert-error').addClass('uchk-alert uchk-alert-ok').show();
    }
}

// ====================================================
// ✅ ตารางข้อมูลทั่วไป — แสดงรายการตรงๆ ไม่มี header หมวด
// ====================================================
function buildUptDataTable(rows) {
    if (!rows || rows.length === 0) return '';
    var cols = Object.keys(rows[0]);
    var h = '<table class="udtbl"><thead><tr>';
...
function toggleURow(hdr) {
    var row = hdr.closest('.ufile-row');
