...
$this->title = 'FDH-OPD_เกิดสิทธิ์ทันที';
...
.my-striped-table tbody tr:hover {
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        <a href="<?= Url::to(['f16oparise/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
                                    RunToken <i class="fa fa-arrow-circle-right"></i></a>
                                    <a href="<?= \yii\helpers\Url::to(['fdhoparise/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16oparise/exports'], ['class' => 'btn btn-success']) ?>
                    </div>
                    </div>
 ...
 <div class="container" style="padding-top: 0;">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <?php $form = ActiveForm::begin(['action' => ['f16oparise/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16oparise/data'], 'post', ['name' => 'frmMain']); ?>
			...
			?>
				...
				<div class="floating-button" 
					...
					<button type="submit" 
							...
							style="background-color: #9ed916; border: 4px solid #dadada; padding: 10px 20px; 
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
            ...
            <!--<input name="btnButton1" class="btn btn-success btn btn-block btn-blink" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH OP-เกิดสิทธิ์ทันที" style="background-color: #00a400; border: 4px solid #dadada; font-size: 16px; transition: all 0.3s;">-->
    ...
    <tbody>
        ...
        <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#F2DEF9' : '#d4f4e8'); ?>;">
            ...
            <td class="text-nowrap" style="font-size: 14px; <?= ($duplicate) ? 'color: red;' : 'color: green;'; ?>"><?php echo $value["Diag"]; ?></td>
            <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["drug_name"]; ?></td>
