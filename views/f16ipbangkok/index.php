...
.my-striped-table tbody tr:hover {
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['f16ipbangkok/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
 ...
 <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16ipbangkok/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
								   class="btn btn-info" 
        ...
        <a href="javascript:void(0);" id="exportExcelButton" class="btn btn-primary" style="font-size: 16px; border: 4px solid #91ffff;" onclick="openPopup();">
            รายชื่อและส่งออก ExcelFiles <i class="fa fa-arrow-circle-right"></i>
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhipbangkok/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16ipangkok/exports'], ['class' => 'btn btn-success']) ?>
...
<br>
    ...
    <div class="page-container">
        ...
        <div id="loading-spinner" style="display: none;">
            ...
            <?= Html::beginForm(['f16ipbangkok/data'], 'post', ['name' => 'frmMain']); ?>
