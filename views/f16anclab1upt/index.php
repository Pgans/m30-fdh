...
$this->title = 'ระบบบริหารจัดการข้อมูล [FDH-ANC-LAB1-UPT]';
...
<div class="anc-page-wrapper">
    ...
    <div class="anc-page-title">
      ...
      เงื่อนไข:: สิทธิ์บัตรทอง รหัสโรค Z348 -upt->'lab_id = '039'-> Pregnancy test
    </div>
    ...
    <div class="control-container">
        ...
        <div class="control-card card-teal">
            ...
            <a href="<?= Url::to(['f16anclab1upt/run-curl']) ?>" class="pill-btn pill-teal">
    ...
    <div class="date-form-inner">
        ...
        <div class="anc-page-title" style="
            background: linear-gradient(135deg,#ff6eb4,#ff3d9a,#e91e8c);
            font-size:24px;
            padding:10px 22px;
            border-radius:12px;
            box-shadow:0 4px 16px rgba(255,61,154,.3);
            margin:0;
        ">
    ...
    <div class="quick-links-bar">
        ...
        <?= Html::a('<i class="fa fa-window-restore"></i> Query ในหน้านี้ (Modal)', '#', [
            ...
            'data-url' => Url::to(['/fdhanclab1upt/index']),
        ]) ?>
        
        <span class="sep">|</span>
        <a href="<?= Url::to(['f16anclab1upt/exports', 'date1' => $date1, 'date2' => $date2]) ?>" class="ql-success">
    ...
    ?>
        <div class="floating-container">
            <?= Html::submitButton(
                '<i class="fa fa-paper-plane"></i> ส่งข้อมูล f16-ANC-LAB1-UPT',
...
<?php $this->registerJs(
    ...
    "var _url     = '" . Url::to(['f16anclab1upt/check']) . "';",
...
// ═══ 2. MODAL ใหม่สำหรับแสดงหน้าต่าง QUERY ระบบ f16anclab1upt ═══
Modal::begin([
    'id'     => 'queryDataModal',
    'header' => '<h4 style="font-weight:700;color:#6c48ff;margin:0;"><i class="fa fa-window-restore"></i> ข้อมูลระบบตรวจสอบแผนกเดนท์ [fdhanclab1upt]</h4>',
    'size'   => Modal::SIZE_LARGE,
]);
