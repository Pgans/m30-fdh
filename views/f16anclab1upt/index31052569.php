        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhanclab1upt/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
		...
		?>
			...
			<div class="floating-button" 
				...
				<button type="submit" 
						...
						style="background-color: #00b8c1; border: 4px solid #dadada; padding: 10px 20px; 
