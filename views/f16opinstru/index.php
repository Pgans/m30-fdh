...
<body>
	...
	<style>
        .info-card {
            background: linear-gradient(45deg, #d6aafa, #e0f7fa); /* Canva-like gradient */
...
.my-striped-table tbody tr:hover {
    ...
    <h4><a>เงื่อนไข:: </a> สิทธิ์บัตรทอง 10953 chrgitem = '21'  ปรับส่งหลายวันได้</h4>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16opinstru/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16opinstru/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhopinstrument/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                       <?= Html::a('Export', ['f16opinstru/exports'], ['class' => 'btn btn-success']) ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-3">
        <?php $form = ActiveForm::begin(['action' => ['f16opinstru/index']]); ?>
  ...
  <div class="page-container">
    ...
    <div style="height: 500px; overflow-y: auto;">
        ...
        <?= Html::beginForm(['f16opinstru/data'], 'post', ['name' => 'frmMain']); ?>
        ...
        <!-- ====================================================
             ตาราง
             ==================================================== -->
        <table class="table my-striped-table" width="1100" border="0" bordercolor="#ddd"
               style="border-collapse:collapse; box-shadow:2px 2px 5px rgba(0,0,0,0.2);">
            <tr>
                <th width="30" style="background-color:#f7faf9;">
                    <div align="center">
                        <input name="CheckAll" type="checkbox" id="CheckAll" value="Y" onClick="ClickCheckAll(this);">
                    </div>
                </th>
                <td width="30"  style="background-color:#f7faf9;" align="center">#</td>
                <td width="80"  style="background-color:#f7faf9;" align="center">วันที่</td>
                <td width="80"  style="background-color:#f7faf9;" align="center">เลขบริการ</td>
                <td width="50"  style="background-color:#f7faf9;">Hn</td>
                <td width="150" style="background-color:#f7faf9;">ชื่อ-สกุล</td>
                <td width="30"  style="background-color:#f7faf9;">อายุ</td>
                <td width="50"  style="background-color:#f7faf9;">แผนก</td>
                <td width="50"  style="background-color:#f7faf9;">โรคหลัก</td>
                <td width="50"  style="background-color:#f7faf9;">โรครอง</td>
                <td width="50"  style="background-color:#f7faf9;">สิทธิ์</td>
                <td width="50"  style="background-color:#f7faf9;">สถานหลัก</td>
                <td width="50"  style="background-color:#f7faf9;">สถานรอง</td>
                <td width="80"  style="background-color:#f7faf9;">สถานะ</td>
                <td width="60"  style="background-color:#f7faf9;">claim_anc</td>
                <td width="80"  style="background-color:#f7faf9;">authen</td>
                <td width="85"  style="background-color:#f7faf9; text-align:center;">ตรวจสอบ</td>
            </tr>
 
            <?php foreach ($dataProvider->getModels() as $key => $value) : ?>
                <tr style="background-color:<?= empty($value['messagecode']) ? '#F2DEF9' : '#d4f4e8'; ?>;">
                    <td>
                    ...
                    <td class="text-nowrap" style="font-size:14px;"><?= $value["Diagx"]; ?></td>
                    ...
                    <td class="text-nowrap" style="font-size:14px;"><?= $value["hospsub"]; ?></td>
                    <td class="text-nowrap" style="font-size:14px;"><?= $value["messagecode"]; ?></td>
                    <td class="text-nowrap" style="font-size:14px;"><?= $value["claim_code"]; ?></td>
                    <td class="text-nowrap" style="font-size:14px;"><?= $value["claimcode"]; ?></td>
                    <!-- ✅ เปลี่ยนเป็น openCheckModal -->
                    <td style="text-align:center; padding:4px;">
                        <button type="button"
                                style="background:#0F6E56; color:#fff; border:none; border-radius:6px;
    ...
    <!-- ====================================================
         Script เดิม (ClickCheckAll + form submit)
         ==================================================== -->
    <script>
    function ClickCheckAll(vol) {
...
<!-- ====================================================
     ✅ include _check_modal.php (universal)
     วางไฟล์ _check_modal_universal.php ไว้ที่
     views/f16opinstru/ แล้ว rename เป็น _check_modal.php
     ==================================================== -->
<?php include __DIR__ . '/_check_modal.php'; ?>
