...
<body>
	...
	<style>
        .info-card {
           background: linear-gradient(45deg, #e0bbff, #f3e5f5); /* Purple gradient */
...
.my-striped-table tbody tr:hover {
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['f16opinstru/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <input name="btnButton1" class="btn btn-success btn btn-block btn-blink" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล OP-Instrument" style="background-color: #00a400; border: 4px solid #dadada; font-size: 20px; transition: all 0.3s;">
