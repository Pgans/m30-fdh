...
<style>
 ...
 <style>
        .info-card {
            background: linear-gradient(45deg, #00ff00, #ccffcc); /* Canva-like gradient */
...
.my-striped-table tbody tr:hover {
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); width: 350px; height: 140px;">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-3"> <!-- ปรับขนาดที่นี่ -->
    ...
    <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#F2DEF9' : '#a7f2cd'); ?>;">
        <td><input type="checkbox" name="chkDel[]"  id="chkDel<?= $key; ?>" value="<?php echo $value["visit_id"] . $value["an"]; ?>"></td>
