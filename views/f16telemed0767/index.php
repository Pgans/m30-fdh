...
.my-striped-table tbody tr:hover {
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
             <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16telemed/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); width: 350px; height: 140px;">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-3">
                            <?php $form = ActiveForm::begin(['action' => ['f16telemed/index']]); ?>
    ...
    <tr style="background-color: <?php echo ($value['response'] == 'สำเร็จ' ? '#80F4BA' : '#F2DEF9'); ?>;">
        ...
        <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["height"]; ?></td>
        ...
        <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["response"]; ?></td>
    </tr>
<?php endforeach; ?>
</table>
</div>
