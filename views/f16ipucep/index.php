...
<body>
    ...
    .floating-button button {
        background-color: #6f59e3; /* สีพื้นหลังใหม่ */
...
.my-striped-table tbody tr:hover {
    ...
    <div class="row">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['f16ipucep/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16ipnormal/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <a href="javascript:void(0);" id="exportExcelButton" class="btn btn-primary" style="font-size: 16px; border: 4px solid #91ffff;" onclick="openPopup();">
            รายชื่อและส่งออก ExcelFiles <i class="fa fa-arrow-circle-right"></i>
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhipucep/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
           ...
           <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); width: 350px; height: 140px;">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-3">
                            <?php $form = ActiveForm::begin(['action' => ['f16ipucep/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div id="loading-spinner" style="display: none;">
            ...
            <?= Html::beginForm(['f16ipucep/data'], 'post', ['name' => 'frmMain']); ?>
    ...
    <button type="submit" 
            ...
            style="background-color: #6f59e3; border: 4px solid #dadada; padding: 10px 20px; border-radius: 30px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); font-size: 1.5rem; text-transform: uppercase; cursor: pointer; width: auto;">
        <i class="fa fa-arrow-circle-right" style="margin-right: 10px;"></i>
        ส่งข้อมูล IP_UCEP
    </button>
</div>
            <!-- <form id="checkbo" name="frmMain" action="index" method="post"> -->
            <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล IP-UCEP" style="background-color: #e0bbff; border: 4px solid #dadada;font-size: 16px;">
            <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse;">
				...
				<td width="30" style="background-color: lightgray;">
                    <div align="left" style="font-size: 14px;">State </div>
                </td>
                <td width="30" style="background-color: lightgray;">
	...
	<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["PT_STATES"]; ?></div>
