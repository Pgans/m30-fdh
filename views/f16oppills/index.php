...
.my-striped-table tbody tr:hover {
    ...
    <h4><a>เงื่อนไข:: </a>icd10 = Z308, ดึงจากการใช้ยา '2376'=Implant EtoNorgestrel เป็นคนไทย  สิทธิ์บัตรทอง  ('03','04','33') Type = 3 CODE= FP002_1 ราคา 2150 บาท</h4>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                <a href="<?= Url::to(['f16oppills/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16oppills/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhoppills/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                       <?= Html::a('Export', ['f16oppills/exports'], ['class' => 'btn btn-success']) ?>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 600px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16oppills/data'], 'post', ['name' => 'frmMain']); ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
           ...
           <!-- <input name="btnButton1" class="btn btn-success btn btn-block btn-blink" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล OP-ฝังยาคุมกำเนิด" style="background-color: #00a400; border: 4px solid #dadada; font-size: 16px; transition: all 0.3s;">
			-->
            ...
            <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
                ...
                <?php foreach ($dataProvider->getModels() as $key => $value) : ?><tr style="background-color: <?php echo (empty($value['messagecode']) ? '#f9edfc' : '#e4f7f0'); ?>;"> <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#f9edfc' : '#e4f7f0'); ?>;">
                       <td>
    <input type="checkbox" name="chkDel[]" id="chkDel<?= $i; ?>" value="<?= $value["visit_id"]; ?><?= $value["hn"]; ?>" style="width: 18px; height: 18px;">
</td>
