...
$this->title = 'IP-OFC สิทธิ์ข้าราชการ';
				...
				<div style="text-align: right;">
                  ...
                  <?php
					echo Html::a('<i class="fa fa-folder-open"></i> เปิดอ่านไฟล์', '#', [
						...
						'data-toggle' => 'modal',
						'data-target' => '#myModal',
						'data-url' => \yii\helpers\Url::to(['f16ipofc/list-files-partial']),
					]);
					?>
 ...
 <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                 ...
                 <div style="text-align: right;">
                <a href="<?= Url::to(['f16ipofc/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
        ...
        <a href="javascript:void(0);" id="exportExcelButton" class="btn btn-primary" style="font-size: 16px; border: 4px solid #91ffff;" onclick="openPopup();">
            รายชื่อและส่งออก ExcelFiles <i class="fa fa-arrow-circle-right"></i>
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhipofc/index']) ?>" 
					   class="btn"
					   style="
                    ...
                    <!--<?= Html::a('Export', ['f16ipofc/exports'], ['class' => 'btn btn-success']) ?>-->
...
<br>
    ...
    <div class="page-container">
        ...
        <div id="loading-spinner" style="display: none;">
            ...
            <?= Html::beginForm(['f16ipofc/data'], 'post', ['name' => 'frmMain']); ?>
...
?>
    ...
    <div class="floating-button" 
        ...
        <button type="submit" 
            ...
            ส่งข้อมูล IP-OFC สิทธิ์ข้าราชการ
        </button>
    </div>
<?php endif; ?>
 ...
 <!--<input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล IP Normal" style="background: linear-gradient(45deg, #00a400; , #00a400;); border: 4px solid #dadada; font-size: 18px; color: white; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">-->
    ...
    <tbody>
        ...
        <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#F2DEF9' : '#d4f4e8'); ?>;">
			...
			<?php
			$claimCode = trim($value["claim_code"]); // ตัดช่องว่างก่อน-หลัง
			$length = strlen($claimCode);
			$color = ($length === 9) ? 'green' : 'red';
			?>

			<td class="text-nowrap" style="font-size: 14px; color: <?= $color ?>;">
