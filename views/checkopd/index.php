    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-box bg-success" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <a href="<?= Url::to(['checkopd/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); width: 350px; height: 140px;">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-3">
                            <?php $form = ActiveForm::begin(['action' => ['checkopd/index']]); ?>
...
<!-- Your form -->
<form name="frmMain" method="post" action="<?= Html::encode(['checkopd/check']); ?>">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php foreach ($visitProvider->getModels() as $key => $value): ?>
                    <tr>
                        <td><input type="checkbox" name="chkDel[]" id="chkDel<?= $i; ?>" value="<?= $value["visit_id"] . $value["pid"]; ?>"></td>
                        <td class="badge"><?= $value["No"]; ?></td>
                        <td class="text-nowrap" style="font-size: 14px;"><?= $value["d_update"]; ?></td>
                        <td style="font-size: 14px;"><?= $value["visit_id"]; ?></td>
                        <td style="font-size: 14px;"><?= $value["pid"]; ?></td>
                        <td class="text-nowrap" style="font-size: 14px;"><?= $value["response"]; ?></td>
