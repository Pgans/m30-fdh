...
$this->title = 'FDH{OPD_ฝังเข็ม-upt}';
...
.my-striped-table tbody tr:hover {
    ...
    <div class="row">
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        <a href="<?= Url::to(['f16opimcupt/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
                                    Token-yoo <i class="fa fa-arrow-circle-right"></i></a>
                                    <a href="<?= \yii\helpers\Url::to(['fdhopimcupt/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
 	...
 	ฝังเข็ม ict10tm = 'U61.10'  และ upt = 'lab_id = '039'-> Pregnancy test	
 <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-4">
        <?php $form = ActiveForm::begin(['action' => ['f16opimcupt/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16opimcupt/data'], 'post', ['name' => 'frmMain']); ?>
		<?php
