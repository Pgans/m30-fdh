...
$this->title = 'OP-ฝัง-ถอนยาคุมกำเนิด+upt';
...
.my-striped-table tbody tr:hover {
    ...
    <a>เงื่อนไข:: </a>
    icd10 = Z308, Z304 ดึงจากการใช้ยา '2376'=Implant EtoNorgestrel , 8605  เป็นคนไทย 
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
				 ...
				 <div style="text-align: right;">
                  <a href="<?= Url::to(['f16optonpillsupt/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16optonpillsupt/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhoptonpillsupt/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                       <?= Html::a('Export', ['f16optonpillsupt/exports'], ['class' => 'btn btn-success']) ?>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16optonpillsupt/data'], 'post', ['name' => 'frmMain']); ?>
			...
			?>
				...
				<div class="floating-button" 
					...
					<button type="submit" 
						...
						ส่งข้อมูล OP-ฝัง-ถอนยาคุมกำเนิด + upt
					</button>
				</div>
			<?php endif; ?>
...
<script>
    ...
    id="selectAll" 
    type="submit" 
    value="ส่งข้อมูล OP-ฝัง-ถอนยาคุมกำเนิด + upt" 
           ...
           transition: all 0.3s;">
            ...
            <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
                ...
                <?php foreach ($dataProvider->getModels() as $key => $value) : ?>
                  <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#e4f0eb' : '#e4f7f0'); ?>;">
