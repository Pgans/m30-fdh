...
<head>
    ...
    <title>Total Visits IPD ผู้ป่วยใน </title>
...
<div class="btn-group-modern">
    <a href="<?= Url::to(['/logclosevisits7/index']) ?>" class="btn-modern btn-cidhn">
        <i class="fa fa-check-square-o"></i> LOG-รายวัน
    </a>
    <a href="<?= Url::to(['/totalvisits/index']) ?>" class="btn-modern btn-opd">
        <i class="fa fa-check-square-o"></i> Total Visits OPD
    </a>
	 <a href="<?= Url::to(['/totalvisitsipd/index']) ?>" class="btn-modern btn-opd">
        <i class="fa fa-check-square-o"></i> Total Visits IPD
    </a>
    <a href="<?= Url::to(['/closevisit/index']) ?>" class="btn-modern btn-opd">
        <i class="fa fa-check-square-o"></i> จองตรวจเสร็จ(Auto)
    </a>
...
<!-- ########################  จบปุ่มเมนู ########################################-->
   ...
   <script type="text/javascript">
    setTimeout("frmMain.submit();",20000);
    //5000 อยากได้เร็วก็กำหนดตัวเลขน้อยๆเอานะ // ฟังก์ชันสำหรับส่งฟอร์มอัตโนมัติหลังจาก 20 วินาที (20000 มิลลิวินาที)
    </script> -->
...
<script language="JavaScript">
    ...
    background: linear-gradient(to right, #d9f99d, #fcb1fc); /* Gradient from light green to light pink */
...
">
                ...
                <div style="text-align: right;">
                <a href="<?= Url::to(['totalvisitsipd/run-curl']) ?>" class="btn btn-lightwarning" style="font-size: 16px;">
...
">
        ...
        <?= Html::beginForm(['totalvisitsipd/check'], 'post', ['name' => 'frmMain']); ?>

        <!-- <form id="checkbo" name="frmMain" action="index" method="post"> -->
        <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH Total Visits" style="background-color: #fcb1fc; border: 4px solid #dadada;">
        ...
        <table class="table table-striped" width="1000" border="0">
            <tr>
                ...
                <td width="70" style="background-color: lightgray;">
				 ...
				 <td width="30" style="background-color: lightgray;">
                    <div align="left" class="text-nowrap" style="font-size: 14px;"> รหัสสิทธิ์ </div>
                </td>
                <td width="30" style="background-color: lightgray;">
    ...
    <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["admitdate"]; ?></div>
    </td>
	
    <td style="font-size: 14px; color: <?php echo $an; ?>;">
                <?php echo $value["an"]; ?>
            </td>
	...
	<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["nhsocode"]; ?></div>
    </td>
...
<?php 
echo Html::beginForm(['totalvisitsipd/delete-multiple'], 'post'); // เริ่มต้นฟอร์ม POST สำหรับ multi-delete
