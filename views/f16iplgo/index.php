                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['f16iplgo/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
            ...
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"> 0</span>
							...
							<a href="<?= Url::to(['f16iplgo/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
								   class="btn btn-info" 
        ...
        <a href="javascript:void(0);" id="exportExcelButton" class="btn btn-primary" style="font-size: 16px; border: 4px solid #91ffff;" onclick="openPopup();">
            รายชื่อและส่งออก ExcelFiles <i class="fa fa-arrow-circle-right"></i>
                    ...
                    <script>
						...
						<a href="<?= \yii\helpers\Url::to(['fdhiplgo/index']) ?>" 
					   class="btn"
					   style="
                    ...
                    <!--<?= Html::a('Export', ['f16iplgo/exports'], ['class' => 'btn btn-success']) ?>-->
...
<br>
    ...
    <div class="page-container">
        ...
        <div id="loading-spinner" style="display: none;">
            ...
            <?= Html::beginForm(['f16iplgo/data'], 'post', ['name' => 'frmMain']); ?>
