    ...
    <div class="col-xl-3 col-md-12 mb-12">
        <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
            ...
            <div style="text-align: right;">
                ...
                <a href="<?= Url::to(['f16opbangkok/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" class="btn btn-info" style="font-size: 16px; border-radius: 25px;">
                ...
                <?= Html::a('Export', ['f16opbangkok/exports'], ['class' => 'btn btn-success']) ?>
            ...
            <div class="page-container">
                <div style="height: 500px; overflow-y: auto;">
                    ...
                    <?= Html::beginForm(['f16opbangkok/data'], 'post', ['name' => 'frmMain', 'id' => 'formMains']); ?>
                        ...
                        ?>
                            <div class="floating-button" style="position: fixed; bottom: calc(3 * 2rem); left: 50%; transform: translateX(-50%); z-index: 1000;">
                                <button type="button" name="btnSubmit" id="btnSubmit" class="btn btn-success btn btn-block" style="background-color: #e88635; border: 4px solid #dadada; padding: 10px 20px; border-radius: 30px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); font-size: 1.5rem; text-transform: uppercase; cursor: pointer; width: auto;">
                                    ...
                                    <td align="center">
                                        <?= Html::a('<i class="fa fa-folder-open"></i>', '#', [
                                            ...
                                            'data-url'    => \yii\helpers\Url::to([
                                                'f16opbangkok/list-files-partial',
