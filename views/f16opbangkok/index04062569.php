...
$this->title = 'FDH-OPD_สิทธิ์ข้าราชการ กทม.';
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-12 mb-12">
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                <span class="info-box-icon"><i class="far fa-calendar-check" style="color: #f7f7f0;"></i></span>
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['f16opbangkok/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
                        ...
                        <?= Html::a('<i class="fa fa-ban" aria-hidden="true"></i> ไม่ผ่าน', null, ['class' => 'btn btn-danger', 'id' => 'link2']) ?> </a>
                         <a href="<?= Url::to(['f16opbangkok/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
					   style="font-size: 16px; border-radius: 25px;">
						RunToken <i class="fa fa-arrow-circle-right"></i>
				    	</a>
                                    <a href="<?= \yii\helpers\Url::to(['fdhopbangkok/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16opbangkok/data'], 'post', ['name' => 'frmMain']); ?>
			...
			?>
				...
				<div class="floating-button" 
					...
					<button type="submit" 
						...
						ส่งข้อมูล OP-สิทธิ์ข้าราชการ กทม.
					</button>
				</div>
			<?php endif; ?>
...
<!--#############################################################################################################-->
    ...
    <thead>
        <tr>
			...
			<th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
                <div align="left" style="font-size: 14px;">น้ำหนัก </div>
            </th>
			<th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
                <div align="left" style="font-size: 14px;">ส่วนสูง </div>
            </th>
            <th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
			...
			<th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
                <div align="left" style="font-size: 14px;">EDC
                </div>
            </th>
            <th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
    ...
    <tbody>
        ...
        <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#faf2fa' : '#ebfff9'); ?>;">
