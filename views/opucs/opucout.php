...
$this->title = 'OP-สิทธิ์ประกันสุขภาพถ้วนหน้า นอกเขต นอกจังหวัด ';
$this->params['breadcrumbs'][] = $this->title;

// กำหนด CSS สีสันของ .well
$this->registerCss("
.well {
    background: linear-gradient(to right, #04b8ac, #00f2fe);
    color: white;
    padding: 20px;
    border-radius: 10px;
...
.table tbody tr:hover {
    background-color: #6dfcf2 !important; /* สีเขียวอ่อน */
...
.table-green-striped tbody tr:nth-of-type(odd) {
    ...
    .table-green-striped tbody tr:nth-of-type(even) {
...
<div class="table-responsive">
    <?= GridView::widget([
        ...
        'summary' => false,
        'tableOptions' => ['class' => 'table table-bordered table-hover table-sm table-sticky table-green-striped'],
...
<?= Html::a('← กลับหน้าแรก', ['referopd/index3'], [
    ...
    'style' => 'border: 2px solid white; background-color: #04b8ac; color: white;'
]) ?>
