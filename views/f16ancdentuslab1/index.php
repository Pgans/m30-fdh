...
$this->title = 'ระบบบริหารจัดการข้อมูล [f16ancdentuslab1]';
...
<div class="anc-page-wrapper">
    ...
    <div class="anc-page-title">
       ...
       เงื่อนไข:: สิทธิ์บัตรทอง รหัสโรค Z348 หัตถการทำฟัน 2387010, 2330011 อุลตราซาวด์ 88.78 และ Lab1
    </div>
    ...
    <div class="control-container">
        ...
        <div class="control-card card-teal">
            ...
            <a href="<?= Url::to(['f16ancdentuslab1/run-curl']) ?>" class="pill-btn pill-teal">
    ...
    <div class="quick-links-bar">
        ...
        <?= Html::a('<i class="fa fa-window-restore"></i> Query ในหน้านี้ (Modal)', '#', [
            ...
            'data-url' => Url::to(['/fdhancdentuslab1/index']),
        ]) ?>
        
        <span class="sep">|</span>
        <a href="<?= Url::to(['f16ancdentuslab1/exports', 'date1' => $date1, 'date2' => $date2]) ?>" class="ql-success">
            <i class="fa fa-file-excel-o"></i> Export Excel
        </a>
    </div>

    <?= Html::beginForm(['f16ancdentuslab1/data'], 'post', ['name' => 'frmMain']) ?>
    ...
    ?>
        <div class="floating-container">
            <?= Html::submitButton(
                '<i class="fa fa-paper-plane"></i> ส่งข้อมูล [f16-ancdentus-lab1]',
...
<?php $this->registerJs(
    ...
    "var _url     = '" . Url::to(['f16ancdentuslab1/check']) . "';",
...
// ═══ 2. MODAL ใหม่สำหรับแสดงหน้าต่าง QUERY ระบบ f16ancdentuslab1 ═══
Modal::begin([
    'id'     => 'queryDataModal',
    'header' => '<h4 style="font-weight:700;color:#6c48ff;margin:0;"><i class="fa fa-window-restore"></i> ข้อมูลระบบตรวจสอบแผนกเดนท์ [fdhancdentuslab1]</h4>',
    'size'   => Modal::SIZE_LARGE,
]);
