...
.my-striped-table tbody tr:hover {
    ...
    <h4><a>เงื่อนไข:: </a> สิทธิ์บัตรทอง รหัสโรค 'Z348' และหัตถการ('2387010','2330011') รองรับส่งหลายวัน</h4>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16ancdent/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhancdent/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                       <?= Html::a('Export', ['f16ancdent/exports'], ['class' => 'btn btn-success']) ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-3">
        <?php $form = ActiveForm::begin(['action' => ['f16ancdent/index']]); ?>
...
?>
    ...
    <div class="floating-button" 
        ...
        <button type="submit" 
                ...
                style="background-color: #00aaff; border: 4px solid #dadada; padding: 10px 20px; 
