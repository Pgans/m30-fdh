...
$this->title = 'IPD องค์การขนส่งมวลชนกรุงเทพ';
...
.my-striped-table tbody tr:hover {
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['f16ipbmta/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
 ...
 <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
				...
				<a href="<?= Url::to(['f16ipbmta/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
								   class="btn btn-info" 
    ...
    <div class="floating-button" 
        ...
        <button type="submit" 
            ...
            <i class="fa fa-arrow-circle-right" style="margin-right: 10px;"></i>
              ส่งข้อมูล IP-องค์การขนส่งมวลชนกรุงเทพ
        </button>
    </div>
<?php endif; ?>
