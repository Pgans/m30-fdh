                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['f16oplgo/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
                       ...
                       <a href="<?= Url::to(['f16oplgo/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
					   style="font-size: 16px; border-radius: 25px;">
						RunToken <i class="fa fa-arrow-circle-right"></i>
				    	</a>
						
                        <a href="<?= \yii\helpers\Url::to(['fdhoplgo/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16oplgo/exports'], ['class' => 'btn btn-success']) ?>
...
<p>
    ...
    <!--<button class="btn btn-success" onclick="exportToExcel()">📊 ส่งออก Excel</button>-->
</p>
...
<!--#############################################################################################################-->
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16oplgo/data'], 'post', ['name' => 'frmMain']); ?>
...
?>
    ...
    <div class="floating-button" 
        ...
        <button type="submit" 
                ...
                style="background-color: #e88635; border: 4px solid #dadada; padding: 10px 20px; 
