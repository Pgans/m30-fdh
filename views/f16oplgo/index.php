    ...
    <div class="col-xl-3 col-md-12 mb-12">
        <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
            ...
            <div style="text-align: right;">
                ...
                <a href="<?= Url::to(['f16oplgo/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" class="btn btn-info" style="font-size: 16px; border-radius: 25px;">
            ...
            <div class="page-container">
                <div style="height: 500px; overflow-y: auto;">
                    ...
                    <?= Html::beginForm(['f16oplgo/data'], 'post', ['name' => 'frmMain', 'id' => 'formMains']); ?>
