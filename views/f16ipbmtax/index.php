...
$this->title = 'IPD รัฐวิสาหกิจ/สิทธิ์ข้าราชการ กทม';
...
.my-striped-table tbody tr:hover {
 ...
 <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16ipbmta/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <a href="javascript:void(0);" id="exportExcelButton" class="btn btn-primary" style="font-size: 16px; border: 4px solid #91ffff;" onclick="openPopup();">
            รายชื่อและส่งออก ExcelFiles <i class="fa fa-arrow-circle-right"></i>
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhipbmta/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16ipbmta/exports'], ['class' => 'btn btn-success']) ?>
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); width: 350px; height: 140px;">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-3">
                            <?php $form = ActiveForm::begin(['action' => ['f16ipbmta/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div id="loading-spinner" style="display: none;">
            ...
            <?= Html::beginForm(['f16ipbmta/data'], 'post', ['name' => 'frmMain']); ?>
<div class="floating-button" style="position: fixed; bottom: calc(3 * 2rem); left: 50%; transform: translateX(-50%); z-index: 1000;">
    <button type="submit" 
        ...
        ส่งข้อมูล IP-รัฐวิสาหกิจ/ข้าราชการ กทม
    </button>
</div>
 <!--<input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล IP Normal" style="background: linear-gradient(45deg, #00a400; , #00a400;); border: 4px solid #dadada; font-size: 18px; color: white; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">-->
