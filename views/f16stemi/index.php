...
.my-striped-table tbody tr:hover {
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        <a href="<?= Url::to(['f16stemi/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
                                    Token-pgans <i class="fa fa-arrow-circle-right"></i></a>
                                    <a href="<?= \yii\helpers\Url::to(['fdhstemi/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16stemi/exports'], ['class' => 'btn btn-success']) ?>
                    </div>
                    </div>
 ...
 <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-4">
        <?php $form = ActiveForm::begin(['action' => ['f16stemi/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16stemi/data'], 'post', ['name' => 'frmMain']); ?>
			<?php
