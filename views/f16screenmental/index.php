...
$this->title = 'คัดกรองสุขภาพกาย-จิต PCU';
...
<br>
<div class="well">
    <div style="background-color: #9f40ff; padding: 10px; border: 0px solid #D4F1F5; box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
        <font color="white" size="5"><i class='fas fa-bed'></i> ผู้ป่วยนอก UCS 16 แฟ้ม Financail Data Hub</font>
        <div>
    <!-- ข้อความที่ต้องการจัดให้อยู่ด้านซ้าย -->
    <span style="color: yellow;">
        แฟ้มที่เกี่ยวข้อง: person, ncd_person, ncd_person_ncd_hist, mathhn, visit, ctitle, cright, ncd_person_ncd_screen
        *****ลบข้อมูลมีค่าน้ำตาลแต่อายุน้อยกว่า 35 ปี
    </span>
</div>
...
<script>
function openPopup() {
    const url = "<?= \yii\helpers\Url::to(['f16screenmental/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
...
<div>
    ...
    <?php endif; ?>
        ...
        <?= Html::beginForm(['f16screenmental/data'], 'post', ['name' => 'frmMain']); ?>

        <!-- <form id="checkbo" name="frmMain" action="index" method="post"> -->
        <input name="btnButton1" class="btn btn-success btn btn-block" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH OPD" style="background-color: #b05ef2; border: 4px solid #dadada;">
        ...
        <table class="table table-striped" width="1000" border="0">
            <tr>
                ...
                <td width="30" style="background-color: lightgreen;">
                    <div align="left" class="text-nowrap" style="font-size: 14px;">บริการ</div>
                </td>
                <td width="30" style="background-color: lightgreen;">
                    <div align="left" style="font-size: 14px;">น้ำหนัก
                </td>
                <td width="30" style="background-color: lightgreen;">
...
<td style="font-size: 14px;"><?php echo $value["age_year"]; ?></div>
...
<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["weight"]; ?></div>
</td>
<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["height"]; ?></div>
</td>
<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["hosmain"]; ?></div>
</td>
<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["hossub"]; ?></div>
</td>
<td class="text-nowrap" style="font-size: 14px;"><?php echo $value["dateexpire"]; ?></div>
</td>
