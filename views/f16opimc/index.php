...
<body>
	...
	<style>
        .info-card {
            background: linear-gradient(45deg,#f2f5f4, #f3f5f2); /* สีเขียวอ่อนแบบ gradient */
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        <a href="<?= Url::to(['f16opimc/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
					   style="font-size: 16px; border-radius: 25px;">
						RunToken <i class="fa fa-arrow-circle-right"></i>
				    </a>
									
                        <a href="<?= \yii\helpers\Url::to(['fdhopimc/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16opimc/exports'], ['class' => 'btn btn-success']) ?>
                    </div>
                    </div>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 600px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16opimc/data'], 'post', ['name' => 'frmMain']); ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
          ...
          <!--  <input name="btnButton1" class="btn btn-success btn btn-block btn-blink" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH OP-ฝังเข็ม" style="background-color: #00a400; border: 4px solid #dadada; font-size: 16px; transition: all 0.3s;">
			-->
            <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
                ...
                <td width="30" style="background-color: #a8e6cf;position: sticky; top: 0; z-index: 1;">
                ...
                <td width="150" style="background-color: #a8e6cf;position: sticky; top: 0; z-index: 1;">
