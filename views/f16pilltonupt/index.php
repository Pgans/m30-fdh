...
$this->title = 'FDH{OPD_ถอนยาคุม+upt}';
...
<body>
	...
	<style>
        .info-card {
            background: linear-gradient(45deg, #a8e6cf, #ffe4e1); /* สีเขียวอ่อนแบบ gradient */ #a8e6cf
...
.my-striped-table tbody tr:hover {
    ...
    <br>
	เงื่อนไข:: icd10= Z304, icd9 = '86.05' ถอนยาคุม , UC('03','04','33'), Type= 3 Code = FP002_2 ราคา 350 บาท
	        upt->'lab_id = '039'-> Pregnancy test  , 'TYPE','30014' ราคา  75.00 บาท
    <div class="row">
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                       ...
                       <a href="<?= Url::to(['f16pilltonupt/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
					   style="font-size: 16px; border-radius: 25px;">
						...
						<a href="<?= \yii\helpers\Url::to(['fdhpilltonupt/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16pilltonupt/exports'], ['class' => 'btn btn-success']) ?>
                    </div>
                    </div>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16pilltonupt/data'], 'post', ['name' => 'frmMain']); ?>
		...
		<button type="submit" 
				...
				style="background-color: #058bb0; border: 4px solid #dadada; padding: 10px 20px; border-radius: 30px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); font-size: 1.5rem; text-transform: uppercase; cursor: pointer; width: auto;">
			<i class="fa fa-arrow-circle-right" style="margin-right: 10px;"></i>
			ส่งข้อมูล OP-ถอนยาคุม+UPT
		</button>
	</div>
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
          ...
          <!--  <input name="btnButton1" class="btn btn-success btn btn-block btn-blink" id="selectAll" type="submit" name="selectAll" value="ส่งข้อมูล FDH OP-ถอนยาคุม+UPT" style="background-color: #00a400; border: 4px solid #dadada; font-size: 20px; transition: all 0.3s;">-->
            ...
            <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
                ...
                <td width="30" style="background-color: #a8e6cf;">
				 ...
				 <td width="30" style="background-color: #a8e6cf;">
                    <div align="left" style="font-size: 14px;">แลบ-upt </div>
                </td>
                <td width="30" style="background-color: #a8e6cf;">
                ...
                <?php foreach ($dataProvider->getModels() as $key => $value) : ?>
                    <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#F2DEF9' : '#f7ebfa'); ?>;">
