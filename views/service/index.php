...
<body>
    <div class="card-body">
        <div class="table-responsive">
            ...
            echo '<th>#</th>';
            echo '<th style="font-size: 14px;">รหัสสถานพยาบาล</th>';
            echo '<th style="font-size: 14px;">สถานพยาบาล</th>';
            ...
            foreach ($allEmpData as $hospcode => $hospname) {
                echo '<tr>'; //เปิดแถวใหม่ ตาราง HTML
                echo '<td>' . $id . '</td>';
                echo '<td style="font-size: 14px;">' . $hospcode . '</td>'; // ปรับขนาดฟอนต์เป็น 14px สำหรับ hospcode
                echo '<td style="font-size: 14px;">' . $hospname . '</td>'; // ปรับขนาดฟอนต์เป็น 16px สำหรับ hospname
                for ($j = 1; $j <= $lastDay; $j++) {
                    ...
                    echo "<td class='number' style='font-size: 14px;'>", $numSeq, "</td>"; // ปรับขนาดฟอนต์เป็น 10px
                }
