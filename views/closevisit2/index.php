...
$this->title = 'ตรวจสอบสถานะการเคลม ผู้ป่วยนอก UCS';
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-box bg-success" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <a href="<?= Url::to(['closevisits2/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); width: 350px; height: 140px;">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-3">
                            <?php $form = ActiveForm::begin(['action' => ['closevisits2/index']]); ?>
...
<?= Html::beginForm(['closevisit2/check'], 'post', ['name' => 'frmMain']); ?>
<!-- Your form -->
<form name="frmMain" method="post" action="<?= Html::encode(['closevisit2/check']); ?>">
        ...
        <table class="table table-striped">
            <thead class="table-header">
                <tr>
                    ...
                    <th width="30">#</th>
                    <th width="30">วันที่ส่ง</th>
                    <th width="30">Visit</th>
                    <th width="30">HN</th>				
                    <th width="70">authen</th>
                    <th width="30">cid</th>
            ...
            <tbody>
                <?php foreach ($visitProvider->getModels() as $key => $value): ?>
                    <tr>
                    <td><input type="checkbox" name="chkDel[]"  id="chkDel<?= $i; ?>" value="<?php echo $value["cid"]; ?><?php echo $value["visit"]; ?>"></td>
                        <td class="badge"><?= $value["No"]; ?></td>
                        <td class="text-nowrap" style="font-size: 14px;"><?= $value["regdate"]; ?></td>
                        <td style="font-size: 14px;"><?= $value["visit"]; ?></td>
                        <td style="font-size: 14px;"><?= $value["hn"]; ?></td>
                        <td class="text-nowrap" style="font-size: 14px;"><?= $value["claimKiosk"]; ?></td>
                        <td class="text-nowrap" style="font-size: 14px;"><?= $value["cid"]; ?></td>
...
<p>
    <?= Html::a('⏪ กลับหน้าหลัก', ['closevisit2/index'], [
...
');
        ...
        <div id="model2" style="display: none;">
            <?php
            echo Html::beginForm(['checkopd/delete-multiple'], 'post'); // เริ่มต้นฟอร์ม POST สำหรับ multi-delete
