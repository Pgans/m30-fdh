...
$this->title = 'JHCIS-ดึงข้อมููลสิทธิ์ สาวไทยแก้มแดง';
...
.my-striped-table tbody tr:hover {
    ...
    <h4><a>เงื่อนไข:: </a> ทุกสิทธิ์ รหัสโรค ('z130') ดึงข้อมููลสิทธิ์ จาก สปสช.</h4> 
	<h5><a>200.14::jhcisdb </a> </h5>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16jthaired/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16jthaired/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhthaiz130/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <!-- <?= Html::a('Export', ['f16jthaired/exports'], ['class' => 'btn btn-success']) ?> -->
                    <a href="<?= Url::to(['personcopy/copydata1']) ?>" class="btn btn-info" style="font-size: 16px;">
    ...
    <div class="row justify-content-center">
        <div class="col-md-3">
        <?php $form = ActiveForm::begin(['action' => ['f16jthaired/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['jhcisinscl/check'], 'post', ['name' => 'frmMain']); ?>

            <!-- <form id="checkbo" name="frmMain" action="index" method="post"> -->
            <input name="btnButton1" class="btn btn-success btn btn-block btn-blink" id="selectAll" type="submit" name="selectAll" value="ดึงข้อมููลสิทธิ์ JHCIS-INSCL" style="background-color: #00a400; border: 4px solid #dadada; font-size: 20px; transition: all 0.3s;">
            ...
            <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
                ...
                <td width="30" style="background-color: lightgreen;">
                    <div align="center" style="font-size: 14px;">cid </div>
                </td>
                <td width="30" style="background-color: lightgreen;">
             ...
             <td width="30" style="background-color: lightgreen;">
                ...
                <?php foreach ($dataProvider->getModels() as $key => $value) : ?>
                    ...
                    <td><input type="checkbox" name="chkDel[]"  id="chkDel<?= $i; ?>" value="<?php echo $value["seq"]; ?><?php echo $value["cid"]; ?><?php echo $value["date_serv"]; ?>">
    ...
    <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["cid"]; ?></div>
    ...
    <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["maininsclName"]; ?></div>
    </td>
