...
$this->title = 'FDH-OPD_SRT สิทธิ์ครูเอกชน';
    ...
    <div class="col-xl-3 col-md-12 mb-12">
        <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
            ...
            <div style="text-align: right;">
                ...
                <a href="<?= Url::to(['f16opteacher/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" class="btn btn-info" style="font-size: 16px; border-radius: 25px;">
                    RunToken <i class="fa fa-arrow-circle-right"></i>
                </a>

                <a href="<?= \yii\helpers\Url::to(['fdhopteacher/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                    Query <i class="fa fa-arrow-circle-right"></i>
                </a>

                <?= Html::a('Export', ['f16opteacher/exports'], ['class' => 'btn btn-success']) ?>
            ...
            <div class="page-container">
                <div style="height: 500px; overflow-y: auto;">
                    ...
                    <?= Html::beginForm(['f16opteacher/data'], 'post', ['name' => 'frmMain', 'id' => 'formMains']); ?>
                                    ...
                                    <td align="center">
                                        <?= Html::a('<i class="fa fa-folder-open"></i>', '#', [
                                            ...
                                            'data-url'    => \yii\helpers\Url::to([
                                                'f16opteacher/list-files-partial',
