...
<style type="text/css">
	<style>
        /* เพิ่มความกว้างและความยาวของหน้าเว็บ */
        body {
            width: 100%; /* ทำให้หน้าเว็บเต็มหน้าจอตามความกว้าง */
            height: 100vh; /* ทำให้หน้าเว็บเต็มหน้าจอตามความสูง */
        }
    </style>
    .navbar {
    ...
    'columns' => [
        [
            ...
            'value' => function ($model) {
				return '<span style="font-weight: bold; font-size: 18px; color: orange; white-space: nowrap;">' . $model->topic . '</span>';
				},
        ...
        [
           // 'attribute' => 'discription',
            ...
            'value' => function ($model) {
                return '<span style="font-weight: bold; font-size: 18px; color: #2E86C1 ;">' . $model->discription . '</span>';
            },
        ],
        [
            'format' => 'raw',
                    ...
                    return \yii\grid\GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'format' => 'raw',
                                'contentOptions' => ['style' => 'width: 700px;'], // กำหนดความกว้าง
                                'value' => function ($model) {
                            ...
                            [
                                ...
                                'template' => '{view} {update} {extra}', // เพิ่มเติมคอลัมน์ 'extra'
                                'buttons' => [
                                    'extra' => function ($url, $model, $key) {
                                        return Html::a(
                                            '<span class="glyphicon glyphicon-option-vertical"></span>',
                                            null, // ไม่กำหนด URL แต่จะสร้างลิงค์ที่ไม่มีการเปลี่ยนเป้าหมาย
                                            [
                                                'class' => 'dropdown-toggle', // กำหนดคลาสสำหรับ Bootstrap dropdown
                                                'data-toggle' => 'dropdown', // เปิดใช้งาน dropdown
                                            ]
                                        );
                                    },
                                ],
                                ...
                                'header' => 'Extra', // กำหนดหัวของคอลัมน์ 'extra'
                                'format' => 'raw',
                                'value' => function ($model, $key, $index, $column) {
                                    // จะแสดงผลเป็น HTML ตามตัวอย่างด้านล่าง
                                    return '<div class="dropdown">
                                                <a class="btn dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                                                    <span class="glyphicon glyphicon-option-vertical"></span>
                                                </a>
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    ' . Html::a('ไฟล์แนบ', ['agendasubx/update'], ['class' => 'dropdown-item']) . '
                                                    ' . Html::a('xxx', ['controller/subaction2'], ['class' => 'dropdown-item']) . '
