...
.month-oct { background-color: #faf5ff; }
.month-nov { background-color: #f5f3ff; }
.month-dec { background-color: #ede9fe; }
.month-jan { background-color: #faf5ff; }
.month-feb { background-color: #f5f3ff; }
.month-mar { background-color: #ede9fe; }
.month-apr { background-color: #faf5ff; }
.month-may { background-color: #f5f3ff; }
.month-jun { background-color: #ede9fe; }
.month-jul { background-color: #faf5ff; }
.month-aug { background-color: #f5f3ff; }
.month-sep { background-color: #ede9fe; }
