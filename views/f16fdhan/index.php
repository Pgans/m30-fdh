...
$this->title = Yii::t('app', 'Query 16 แฟ้มเลือกตาม AN');
...
<head>
    ...
    <style>
        .panel-3d {
            border: 1px solid #d4d4d4; /* เส้นขอบ */
...
<div class="f16-Query-index">
    ...
    <div class="panel-3d">
    <p>
    <?= Html::a('<i class="fa fa-arrow-circle-right" aria-hidden="true"></i> เพิ่มข้อมูล', ['create'], ['class' => 'btn btn-info']) ?>
