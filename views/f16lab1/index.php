...
$this->title = 'ระบบบริหารจัดการข้อมูล [FDH-LAB1]';
...
<div class="anc-page-wrapper">
    ...
    <div class="control-container">
        ...
        <div class="control-card card-teal">
            ...
            <a href="<?= Url::to(['f16lab1/run-curl']) ?>" class="pill-btn pill-teal">
    ...
    <div class="quick-links-bar">
        ...
        <span class="sep">|</span>
        <a href="<?= Url::to(['f16lab1/exports', 'date1' => $date1, 'date2' => $date2]) ?>" class="ql-success">
    ...
    ?>
        <div class="floating-container">
            <?= Html::submitButton(
                '<i class="fa fa-paper-plane"></i> ส่งข้อมูล f16-lab1',
...
// ═══ 2. MODAL ใหม่สำหรับแสดงหน้าต่าง QUERY ระบบ f16lab1 ═══
Modal::begin([
    'id'     => 'queryDataModal',
    'header' => '<h4 style="font-weight:700;color:#6c48ff;margin:0;"><i class="fa fa-window-restore"></i> ข้อมูลระบบตรวจสอบแผนกเดนท์ [fdhlab1]</h4>',
    'size'   => Modal::SIZE_LARGE,
]);
