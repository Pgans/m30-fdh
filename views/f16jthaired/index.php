...
$this->title = 'JHCIS-สาวไทยแก้มแดง';
...
.my-striped-table tbody tr:hover {
    ...
    <h4><a>เงื่อนไข:: </a> ทุกสิทธิ์ รหัสโรค ('z130') หญิงวัยเจริญพันธุ์ อายุ 13-45 ปี รับบริการยาเม็ดเสริมธาตุเหล็ก 60 มิลลิกรัมและกรดโฟลิก 2,800 ไมโครกรัม สัปดาห์ละ 1 ครั้ง</h4> 
	<h5><a>200.14::jhcisdb </a> fdh_thaired </h5>
    <div class="row">
            ...
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <a href="<?= Url::to(['personcopy/copydata1']) ?>" class="btn btn-info" style="font-size: 16px;">
					 ...
					 <a href="<?= \yii\helpers\Url::to(['jhcisinscl/index']) ?>" class="btn btn-success modalLink" style="font-size: 16px;" target="_blank">
                        ตรวจสิทธิ์ <i class="fa fa-arrow-circle-right"></i>
                    </a>			
                </div>
            </div>
        </div>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16jthaired/data'], 'post', ['name' => 'frmMain']); ?>
			
			<!-- Radio Buttons เลือกการใช้สิทธิ์ -->
<div style="padding: 15px; background: linear-gradient(to right,#b0e2d6 , #d4f4e8); border: 1px solid #ddd; margin-bottom: 20px; display: flex; align-items: center;">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.addEventListener("mouseup", () => {
            ...
            <table class="table my-striped-table" width="1000" border="0" bordercolor="#ddd" style="border-collapse: collapse; box-shadow: 2px 2px 5px rgba(0,0,0,0.2);">
                ...
                <td width="30" style="background-color: #b0e2d6;">
                    <div align="left" style="font-size: 14px;">อายุปี </div>
                </td>
				 <td width="30" style="background-color: #b0e2d6;">
                    <div align="left" style="font-size: 14px;">เดือน </div>
                </td>
             <td width="30" style="background-color: #b0e2d6;">
	...
	<td style="font-size: 14px;"><?php echo $value["age_month"]; ?></div>
