...
<div class="box box-success box-solid" id="grad8">
    ...
    <th style="color:green">ข้อที่ 8</th>
    <th style="color:green">ข้อที่ 9</th>   
  ...
  <tr>
    ...
    <td><?= $form->field($model, 'SC011')->textInput(['id'=>"SC011",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC012')->textInput(['id'=>"SC012",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC013')->textInput(['id'=>"SC013",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC014')->textInput(['id'=>"SC014",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC015')->textInput(['id'=>"SC015",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC016')->textInput(['id'=>"SC016",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC017')->textInput(['id'=>"SC017",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC018')->textInput(['id'=>"SC018",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC019')->textInput(['id'=>"SC019",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>  
    <td><?= $form->field($model, 'NO01')->textInput(['id'=>'NO01','size'=>1,'maxlength' => 1,'autocomplete'=>'off'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC01')->textInput(['id'=>"DEC01",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td> 
 ...
 <tr>
    ...
    <td><?= $form->field($model, 'SC021')->textInput(['id'=>"SC021",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC022')->textInput(['id'=>"SC022",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC023')->textInput(['id'=>"SC023",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC024')->textInput(['id'=>"SC024",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC025')->textInput(['id'=>"SC025",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC026')->textInput(['id'=>"SC026",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC027')->textInput(['id'=>"SC027",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC028')->textInput(['id'=>"SC028",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC029')->textInput(['id'=>"SC029",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>  
    <td><?= $form->field($model, 'NO02')->textInput(['id'=>'NO02','size'=>1,'maxlength' => 1,'autocomplete'=>'off'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC02')->textInput(['id'=>"DEC02",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td> 
 </tr>
 <tr>
  	<td><font>3</font></td>
    ...
    <td><?= $form->field($model, 'SC031')->textInput(['id'=>"SC031",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC032')->textInput(['id'=>"SC032",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC033')->textInput(['id'=>"SC033",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC034')->textInput(['id'=>"SC034",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC035')->textInput(['id'=>"SC035",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC036')->textInput(['id'=>"SC036",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC037')->textInput(['id'=>"SC037",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC038')->textInput(['id'=>"SC038",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC039')->textInput(['id'=>"SC039",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>  
    <td><?= $form->field($model, 'NO03')->textInput(['id'=>'NO03','size'=>1,'maxlength' => 1,'autocomplete'=>'off'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC03')->textInput(['id'=>"DEC03",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td> 
 </tr>
 <tr>
  	<td><font>4</font></td>
    ...
    <td><?= $form->field($model, 'SC041')->textInput(['id'=>"SC041",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC042')->textInput(['id'=>"SC042",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC043')->textInput(['id'=>"SC043",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC044')->textInput(['id'=>"SC044",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC045')->textInput(['id'=>"SC045",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC046')->textInput(['id'=>"SC046",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC047')->textInput(['id'=>"SC047",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC048')->textInput(['id'=>"SC048",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC049')->textInput(['id'=>"SC049",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>  
    <td><?= $form->field($model, 'NO04')->textInput(['id'=>'NO04','size'=>1,'maxlength' => 1,'autocomplete'=>'off'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC04')->textInput(['id'=>"DEC04",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td> 
 </tr>
 <tr>
  	<td><font>5</font></td>
    ...
    <td><?= $form->field($model, 'SC051')->textInput(['id'=>"SC051",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC052')->textInput(['id'=>"SC052",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC053')->textInput(['id'=>"SC053",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC054')->textInput(['id'=>"SC054",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC055')->textInput(['id'=>"SC055",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC056')->textInput(['id'=>"SC056",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC057')->textInput(['id'=>"SC057",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC058')->textInput(['id'=>"SC058",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC059')->textInput(['id'=>"SC059",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>  
    <td><?= $form->field($model, 'NO05')->textInput(['id'=>'NO05','size'=>1,'maxlength' => 1,'autocomplete'=>'off'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC05')->textInput(['id'=>"DEC05",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td> 
 </tr>
 <tr>
  	<td><font></font></td>
    ...
    <td><?= $form->field($model, 'SC061')->textInput(['id'=>"SC061",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC062')->textInput(['id'=>"SC062",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC063')->textInput(['id'=>"SC063",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC064')->textInput(['id'=>"SC064",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC065')->textInput(['id'=>"SC065",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC066')->textInput(['id'=>"SC066",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC067')->textInput(['id'=>"SC067",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC068')->textInput(['id'=>"SC068",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC069')->textInput(['id'=>"SC069",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>  
    <td><?= $form->field($model, 'NO06')->textInput(['id'=>'NO06','size'=>1,'maxlength' => 1,'autocomplete'=>'off'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC06')->textInput(['id'=>"DEC06",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td> 
 </tr>
 <tr>
 <td><font></font></td>
    ...
    <td><?= $form->field($model, 'SC071')->textInput(['id'=>"SC071",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC072')->textInput(['id'=>"SC072",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC073')->textInput(['id'=>"SC073",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC074')->textInput(['id'=>"SC074",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC075')->textInput(['id'=>"SC075",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC076')->textInput(['id'=>"SC076",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC077')->textInput(['id'=>"SC077",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC078')->textInput(['id'=>"SC078",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC079')->textInput(['id'=>"SC079",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>  
    <td><?= $form->field($model, 'NO07')->textInput(['id'=>'NO07','size'=>1,'maxlength' => 1,'autocomplete'=>'off'])->label(false) ?></td>
    <td><?= $form->field($model, 'DEC07')->textInput(['id'=>"DEC07",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td> 
 </tr>
 <tr>
 <td><font>6</font></td>
    ...
    <td><?= $form->field($model, 'SC088')->textInput(['id'=>"SC088",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC089')->textInput(['id'=>"SC089",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>  
    <td><?= $form->field($model, 'NO08')->textInput(['id'=>'NO08','size'=>1,'maxlength' => 1,'autocomplete'=>'off'])->label(false) ?></td>
 ...
 <td><font>7</font></td>
    ...
    <td><?= $form->field($model, 'SC098')->textInput(['id'=>"SC098",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC099')->textInput(['id'=>"SC099",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>  
    <td><?= $form->field($model, 'NO09')->textInput(['id'=>'NO09','size'=>1,'maxlength' => 1,'autocomplete'=>'off'])->label(false) ?></td>
 ...
 <td><font>8</font></td>
    ...
    <td><?= $form->field($model, 'SC108')->textInput(['id'=>"SC108",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>    
    <td><?= $form->field($model, 'SC109')->textInput(['id'=>"SC109",'size'=>1,'maxlength' => 1, 'onchange'=>'handleSCChk(this)'])->label(false) ?></td>  
    <td><?= $form->field($model, 'NO10')->textInput(['id'=>'NO10','size'=>1,'maxlength' => 1,'autocomplete'=>'off'])->label(false) ?></td>
    ...
    <div align="center" class="form-group">
        <?= Html::submitButton(Yii::t('app', 'บันทึกผู้ป่วยนอก'), ['class' => 'btn btn-success']) ?>
