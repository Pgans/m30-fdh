...
<style>
    ...
    <style>
	 ...
	 <style>
        .info-card {
             background: linear-gradient(45deg, #b8abf5, #d3fbf5); /* Canva-like gradient */ เขียวอ่อน
...
.my-striped-table tbody tr:hover {
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        echo Html::a('เปิดอ่านไฟล์', '#', [
                            ...
                            'data-url' => \yii\helpers\Url::to(['f16ipstp/list-files-partial']), // URL สำหรับโหลดเนื้อหา
                        ]);
                        ?>
 ...
 <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
               ...
               <div style="text-align: right;">
                <a href="<?= Url::to(['f16ipstp/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
        ...
        <a href="javascript:void(0);" id="exportExcelButton" class="btn btn-primary" style="font-size: 16px; border: 4px solid #91ffff;" onclick="openPopup();">
            รายชื่อและส่งออก ExcelFiles <i class="fa fa-arrow-circle-right"></i>
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhipstp/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                    <?= Html::a('Export', ['f16ipstp/exports'], ['class' => 'btn btn-success']) ?>
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); width: 350px; height: 140px;">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-3">
                            <?php $form = ActiveForm::begin(['action' => ['f16ipstp/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div id="loading-spinner" style="display: none;">
            ...
            <?= Html::beginForm(['f16ipstp/data'], 'post', ['name' => 'frmMain']); ?>
...
?>
    ...
    <div class="floating-button" 
        ...
        <button type="submit" 
            ...
            ส่งข้อมูล IP STP ผู้มีปัญหาสถานะสิทธิ์
        </button>
    </div>
<?php endif; ?>
