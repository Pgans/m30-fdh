...
$this->title = 'OP-ถอนยาฝังคุมกำเนิด';
...
<body>
	...
	<style>
        .info-card {
            background: linear-gradient(45deg, #d6aafa, #b0e2d6); /* Canva-like gradient */
...
.my-striped-table tbody tr:hover {
    ...
    <h4><a>เงื่อนไข:: </a>icd10= Z304, icd9 = '8605' , UC('03','04','33'), Type= 3 Code = FP002_2 ราคา 350 บาท</h4>
    <div class="row">
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
				...
				<div style="text-align: right;">
                <a href="<?= Url::to(['f16oppillston/run-curl', 'date1' => $date1, 'date2' => $date2]) ?>" 
					   class="btn btn-info" 
        ...
        <div class="col-xl-3 col-md-3 mb-3">
            <div class="info-card bg-warning" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div class="info-box-content">
                    ...
                    <script>
                        function openPopup() {
                            const url = "<?= \yii\helpers\Url::to(['f16oppillston/exportexcel']); ?>"; // ลิงก์ไปยังไฟล์ Excel
                    ...
                    <a href="<?= \yii\helpers\Url::to(['fdhoppillston/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
                        Query <i class="fa fa-arrow-circle-right"></i>
                    </a>
                       <?= Html::a('Export', ['f16oppillston/exports'], ['class' => 'btn btn-success']) ?>
...
<br>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16oppillston/data'], 'post', ['name' => 'frmMain']); ?>
			...
			?>
				...
				<div class="floating-button" 
					...
					<button type="submit" 
						...
						ส่งข้อมูล OP-ถอนยาฝังคุมกำเนิด
					</button>
				</div>
			<?php endif; ?>
...
<script>
    ...
    <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["code"]; ?></div>
