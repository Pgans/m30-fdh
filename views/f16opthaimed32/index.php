...
$this->title = 'FDH-OPD_สมุนไพรไทย 32 รายการ';
...
<style>
    ...
    <style>
        ...
        .visit-element {
			background-color: rgba(144, 238, 144, 0.3); /* lightgreen แบบจาง */
	...
	<style>
        .info-card {
            background: linear-gradient(45deg, rgba(168, 230, 207, 0.3), rgba(208, 240, 192, 0.3));
          /* background: linear-gradient(45deg, #d6aafa, #ffe4e1); /* ไล่สีชมพูอ่อน */
...
.my-striped-table tbody tr:hover {
            ...
            <div class="info-card bg-info" style="box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3);">
                ...
                <div style="text-align: right;">
                    <div style="text-align: right;">
                        ...
                        <a href="<?= Url::to(['f16opthaimed32/run-curl']) ?>" class="btn btn-info" style="font-size: 16px;">
                                    RunToken <i class="fa fa-arrow-circle-right"></i></a>
                                    <a href="<?= \yii\helpers\Url::to(['fdhopthaimed32/index']) ?>" class="btn btn-warning modalLink" style="font-size: 16px;" target="_blank">
 ...
 <div class="container" style="padding-top: 0;">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <?php $form = ActiveForm::begin(['action' => ['f16opthaimed32/index']]); ?>
    ...
    <div class="page-container">
        ...
        <div style="height: 500px; overflow-y: auto;">
            ...
            <?= Html::beginForm(['f16opthaimed32/data'], 'post', ['name' => 'frmMain']); ?>
		<?php
		...
		?>
			...
			<div class="floating-button" 
				...
				<button type="submit" 
					...
					ส่งข้อมูล OP-สมุนไพรไทย 32 รายการ
				</button>
			</div>
		<?php endif; ?>
...
<script>
    ...
    <thead>
        <tr>
            ...
            <th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
			 ...
			 <th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
                    <div align="left" style="font-size: 14px;">รหัสยา </div>
                </td>
				<th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
                    <div align="left" style="font-size: 14px;">TMT </div>
                </td>
			 <th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
                    <div align="left" style="font-size: 14px;">ชื่อยา </div>
                </td>
            <th width="30" style="background-color: #a8e6cf; position: sticky; top: 0; z-index: 1;">
    ...
    <tbody>
        ...
        <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#F2DEF9' : '#DFF5D5'); ?>;">
            ...
            <td class="text-nowrap" style="font-size: 14px; <?= ($duplicate) ? 'color: red;' : 'color: green;'; ?>">
                <?php echo $value["Diag"]; ?> </td>
			 <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["drug"]; ?></div>
			 <td class="text-nowrap" style="font-size: 14px;"><?php echo $value["tmt"]; ?></div>
			...
			<td class="text-nowrap" style="font-size: 14px; color: #ff6600;">
