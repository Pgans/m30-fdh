...
<style>
    ...
    .table-header {
        ...
        z-index: 15; /* Ensure this row is on top of the table */
            ...
            <!--<div style="height: 700px; overflow-y: auto;">-->
    <table class="table my-striped-table" width="100%" border="1" bordercolor="#ddd" style="border-collapse: collapse;">
        <thead style="position: sticky; top: 0; z-index: 10; background-color: #00d6e1; color: #FFFFFF;">
            <tr>
                <td width="30" style="background-color: #00d6e1; color: #FFFFFF; text-align: center;">
                    <input name="CheckAll" type="checkbox" id="CheckAll" value="Y" onClick="ClickCheckAll(this);">
                </td>
                <td width="30" style="background-color: #00d6e1; color: #FFFFFF; text-align: center;">
                    # 
                </td>
                <td width="30" style="background-color: #00d6e1; color: #FFFFFF; text-align: center; font-size: 14px;">
                    วันที่
                </td>
                <td width="30" style="background-color: #00d6e1; color: #FFFFFF; text-align: center; font-size: 14px;">
                    เลขบริการ
                </td>
                <td width="30" style="background-color: #00d6e1; color: #FFFFFF; text-align: left; font-size: 14px;">
                    Hn
                </td>
                <!--<td width="30" style="background-color: #00d6e1; color: #FFFFFF; text-align: left; font-size: 14px;">
                    Cid
