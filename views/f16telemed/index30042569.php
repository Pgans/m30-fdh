...
<body>
   ...
   <h4><a>เงื่อนไข:: </a> สิทธิ์บัตรทอง  ('03', '04', '33', '00', '23')  แผนก ('63', '68', '70', '71','75','81','82','83','84','85','86')</h4>
    <div class="row">
...
.table-canva thead {
    ...
    /* หรืออีกแนวหนึ่ง: linear-gradient(135deg, #89f7fe 0%, #66a6ff 100%); */
    color: black;
    font-weight: 600;
...
/* ขอบโค้งเฉพาะหัวตาราง */
.table-canva thead tr:first-child td:first-child {
    border-top-left-radius: 12px;
}
.table-canva thead tr:first-child td:last-child {
    border-top-right-radius: 12px;
}

/* Stripe สลับสี */
.table-canva tbody tr:nth-child(odd) {
    background-color: #f9fcff;
}
.table-canva tbody tr:nth-child(even) {
    background-color: #ffffff;
}

/* Hover effect */
.table-canva tbody tr:hover {
...
/* Checkbox modern */
.table-canva input[type="checkbox"] {
    width: 18px;
    height: 18px;
    accent-color: #66a6ff;
    cursor: pointer;
...
<!-- ✅ ใช้คลาส table-canva -->
<table class="table table-canva my-striped-table" width="100%" style="border-collapse: collapse;">
    <thead>
        <tr>
            <td width="30">
        ...
        <tbody>
            <?php foreach ($dataProvider->getModels() as $key => $value) : ?>
                <tr style="background-color: <?php echo (empty($value['messagecode']) ? '#f7edfa' : '#e9f5f0'); ?>;">
