...
class Convert16ucsController extends \yii\web\Controller
{
    ...
    public function actionUpdate()
    {
        ...
        try {
            ...
            $sqlDel = "DELETE FROM ucs_ncd_screen WHERE (bsl <> ' ' AND age_year < '35')";
    ...
    public function actionExports()
    {
      ...
      from adp ";
        ...
        $zipFilename = $baseDirectory . 'F16_10953_UCS' . $currentDateTime . '.zip';
        
        // Extract folder name from the base directory
        $folderName = basename($baseDirectory);
        ...
        foreach ($files as $file) {
            $relativePath = $folderName . '/' . str_replace($baseDirectory . '/', '', $file);
