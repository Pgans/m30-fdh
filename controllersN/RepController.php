...
class RepController extends \yii\web\Controller
{
    ...
    public function actionRep() {
            ...
            $sql = "SELECT r.rep, r.id, r.train_id, r.hn, r.an, r.pid, r.fullname, r.main, r.regdate, r.discharge, r.ins,
            r.pp , r.errorcode, r.sub 
            FROM rep_import r 
            WHERE date(r.regdate) BETWEEN '20/11/2020' AND '30/11/2020'
             ";
